...
HI16/LO16 data pairs. Two JFG `diRcp` return-eight leaves are also exact at
the resident defaults with no relocations: 16-byte `diRcpReserved0` and
20-byte `diRcpStrNameMacro`.
