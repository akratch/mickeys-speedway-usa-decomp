...
**Matching progress.** Fifty-four functions / 2,276 bytes compile exactly
...
- `main/main` (24 / 452 bytes): `mainGetZBCheck`, `mainGameWindowChanging`,
  ...
  `mainGetNumberOfCameras`, `func_80028F54`, `func_80028F98`,
