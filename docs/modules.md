...
**Matching progress.** Fifty-five functions / 2,292 bytes compile exactly
...
- `main/main` (25 / 468 bytes): `mainGetZBCheck`, `mainGameWindowChanging`,
