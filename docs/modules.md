...
**Matching progress.** Sixty-six functions / 2,632 bytes compile exactly
...
- `main/main` (36 / 808 bytes): `mainGetZBCheck`, `mainGameWindowChanging`,
  ...
  `func_800291B4`,
  `func_800291C4`,
  `func_800291D0`, `func_800291D8`, `func_800291E4`, and `func_800291FC`.
