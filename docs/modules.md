...
**Matching progress.** Sixty-two functions / 2,480 bytes compile exactly
...
- `main/main` (32 / 656 bytes): `mainGetZBCheck`, `mainGameWindowChanging`,
  ...
  `func_80029120`, `func_80029144`, `func_800291B4`, `func_800291C4`,
