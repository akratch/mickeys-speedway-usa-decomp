...
- **`0x80080D24` (ROM `0x81924`)** is a weaker bound of a different kind: the
  ...
  cannot see them.
- **rodata order follows text order exactly.** The 27 jump tables still emitted
...
- **rodata order follows text order exactly.** 35 functions, 27 jump tables,
- **rodata order follows text order exactly.** 27 functions, 27 jump tables,
