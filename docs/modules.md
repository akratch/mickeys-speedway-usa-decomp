...
**Matching progress.** Sixty-one functions / 2,452 bytes compile exactly
...
- `main/main` (31 / 628 bytes): `mainGetZBCheck`, `mainGameWindowChanging`,
  ...
  `func_80029120`, `func_800291B4`, `func_800291C4`,
