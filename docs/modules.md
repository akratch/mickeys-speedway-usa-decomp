...
12-byte `diRcpDmaOffsets`. Three 52-byte JFG unpack-and-return bodies,
`diRcpReserved2`, `diRcpMoveMem`, and `diRcpDisplayList`, are exact at the
same defaults, including their helper-call relocations. The 44-byte
