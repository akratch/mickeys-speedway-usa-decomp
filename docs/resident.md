...
| `0x16A90` | `0x12C` | `shadowInitBuffers` | A; exact C, 75 words/relocations; shadows owns `.data` `D_80079410`–`D_8007945C` |
...
| `0x80055F64` | `0x16C` | no unique `hit.c` candidate | tier-D; before/after type pass: operand-mismatch, 3 stack-home words at exact 91 instructions/`0x48` frame; lever volatile stack home, residual target `sp+0x1C` versus candidate `sp+0x18` |
