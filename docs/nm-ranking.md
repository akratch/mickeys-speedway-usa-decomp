...
The snapshot contains **398 queued identities**: **398 resolved measurements** and **0 unresolved identities**. Resolved target size totals **405,928 bytes (396.4 KiB)**.

Resolved rows span **74 overlays** and **1 resident TU group** (`main`).

A supplementary objdiff report was not supplied; `objdiff_match_pct` covers **0 / 398** resolved rows.
...
| 186 | `src/overlays/o041/overlay41SpawnItems.c` | `overlay41SpawnItems` | `o041` | `reloc-mismatch` | 540 | 2 | 128 | 0 | — |
| 187 | `src/overlays/o008/overlay_008.c` | `overlay8UpdateChannels` | `o008` | `reloc-mismatch` | 608 | 6 | 12 | 0 | — |
| 188 | `src/overlays/o014/func_overlay_014_F0000000_186F8D8.c` | `func_overlay_014_F0000000_186F8D8` | `o014` | `reloc-mismatch` | 316 | 23 | 36 | 0 | — |
| 189 | `src/main/vehicle_sounds.c` | `func_80058250` | `main` | `size-mismatch` | 88 | 19 | 0 | 16 | — |
| 190 | `src/main/charControl.c` | `func_8001D880` | `main` | `size-mismatch` | 144 | 32 | 4 | -4 | — |
| 191 | `src/overlays/o001/overlay_001_tail.c` | `overlay1HandleCachedMode` | `o001` | `size-mismatch` | 128 | 32 | 4 | 16 | — |
| 192 | `src/main/fx.c` | `func_800498FC` | `main` | `size-mismatch` | 400 | 33 | 24 | -8 | — |
| 193 | `src/main/menu.c` | `func_8003968C` | `main` | `size-mismatch` | 148 | 33 | 0 | -36 | — |
| 194 | `src/overlays/o015/overlay_015.c` | `overlay15MoveStars` | `o015` | `size-mismatch` | 216 | 33 | 48 | 16 | — |
| 195 | `src/main/track.c` | `func_80012574` | `main` | `size-mismatch` | 228 | 36 | 80 | -8 | — |
| 196 | `src/overlays/o007/overlay_007_tail.c` | `overlay7CommitSelection` | `o007` | `size-mismatch` | 288 | 37 | 4 | -4 | — |
| 197 | `src/main/charControl.c` | `func_8001D2A0` | `main` | `size-mismatch` | 380 | 40 | 224 | 4 | — |
| 198 | `src/overlays/o040/overlay40UpdateEntries.c` | `overlay40UpdateEntries` | `o040` | `size-mismatch` | 184 | 44 | 8 | 4 | — |
| 199 | `src/main/lights.c` | `func_80019DE8` | `main` | `size-mismatch` | 252 | 45 | 68 | 4 | — |
| 200 | `src/overlays/o048/overlay48InitializeState.c` | `overlay48InitializeState` | `o048` | `size-mismatch` | 228 | 47 | 0 | -16 | — |
| 201 | `src/overlays/o001/overlay_001_tail.c` | `overlay1ConsumeNearbyPending` | `o001` | `size-mismatch` | 276 | 50 | 64 | 4 | — |
| 202 | `src/overlays/o001/overlay_001_head.c` | `overlay1MeasureCurves` | `o001` | `size-mismatch` | 316 | 51 | 12 | -4 | — |
| 203 | `src/main/fx.c` | `func_80046EC4` | `main` | `size-mismatch` | 440 | 61 | 44 | 4 | — |
| 204 | `src/main/memory.c` | `func_8002B7AC` | `main` | `size-mismatch` | 252 | 62 | 4 | -4 | — |
| 205 | `src/overlays/o002/overlay2ClassifyBoundary.c` | `overlay2ClassifyBoundary` | `o002` | `size-mismatch` | 316 | 62 | 4 | 4 | — |
| 206 | `src/overlays/o001/overlay_001_head.c` | `overlay1ResolveMotionPoint` | `o001` | `size-mismatch` | 400 | 63 | 44 | -8 | — |
| 207 | `src/main/runlink.c` | `runlinkInit` | `main` | `size-mismatch` | 584 | 64 | 8 | -16 | — |
| 208 | `src/overlays/o015/overlay_015.c` | `overlay15DrawScreenStars` | `o015` | `size-mismatch` | 420 | 65 | 52 | -4 | — |
| 209 | `src/main/camera.c` | `func_80024978` | `main` | `size-mismatch` | 332 | 66 | 8 | -80 | — |
| 210 | `src/main/particles.c` | `func_8003F154` | `main` | `size-mismatch` | 1,188 | 66 | 516 | -12 | — |
| 211 | `src/main/anim.c` | `func_80050E9C` | `main` | `size-mismatch` | 360 | 68 | 28 | 96 | — |
| 212 | `src/overlays/o099/overlay99RenderSegments.c` | `overlay99RenderSegments` | `o099` | `size-mismatch` | 568 | 70 | 8 | -8 | — |
| 213 | `src/main/models_5B300.c` | `func_8005AD64` | `main` | `size-mismatch` | 432 | 74 | 0 | 12 | — |
| 214 | `src/main/saves.c` | `func_8002CF6C` | `main` | `size-mismatch` | 352 | 77 | 8 | -12 | — |
| 215 | `src/overlays/o003/overlay3SelectScoredObject.c` | `overlay3SelectScoredObject` | `o003` | `size-mismatch` | 472 | 77 | 68 | -4 | — |
| 216 | `src/main/charControl.c` | `func_8001C114` | `main` | `size-mismatch` | 432 | 79 | 24 | -8 | — |
| 217 | `src/overlays/o034/overlay34UpdateRecords.c` | `overlay34UpdateRecords` | `o034` | `size-mismatch` | 308 | 79 | 0 | 12 | — |
| 218 | `src/main/matrix.c` | `func_8002AB78` | `main` | `size-mismatch` | 268 | 83 | 0 | 68 | — |
| 219 | `src/overlays/o001/overlay_001_tail.c` | `overlay1UpdateRangeFlags` | `o001` | `size-mismatch` | 480 | 83 | 0 | -4 | — |
| 220 | `src/main/sched.c` | `__scHandleRetrace` | `main` | `size-mismatch` | 1,636 | 84 | 984 | -4 | — |
| 221 | `src/main/track.c` | `func_8000D820` | `main` | `size-mismatch` | 344 | 84 | 0 | -8 | — |
| 222 | `src/main/fx.c` | `func_80048080` | `main` | `size-mismatch` | 356 | 85 | 0 | -20 | — |
| 223 | `src/overlays/o098/overlay98CheckObject.c` | `overlay98CheckObject` | `o098` | `size-mismatch` | 444 | 86 | 0 | -4 | — |
| 224 | `src/overlays/o015/overlay_015.c` | `overlay15UpdateMovingStars` | `o015` | `size-mismatch` | 412 | 87 | 36 | 28 | — |
| 225 | `src/main/diCpu.c` | `func_80046BCC` | `main` | `size-mismatch` | 424 | 89 | 44 | 4 | — |
| 226 | `src/main/matrix.c` | `func_8002AA50` | `main` | `size-mismatch` | 296 | 92 | 0 | 76 | — |
| 227 | `src/overlays/o049/overlay_049.c` | `overlay49Initialize` | `o049` | `size-mismatch` | 500 | 92 | 32 | 4 | — |
| 228 | `src/main/models_5B300.c` | `func_8005ABA8` | `main` | `size-mismatch` | 444 | 97 | 56 | -4 | — |
| 229 | `src/overlays/o004/overlay_004.c` | `overlay4UpdateObjectMotion` | `o004` | `size-mismatch` | 920 | 97 | 68 | -4 | — |
| 230 | `src/main/menu.c` | `func_80038878` | `main` | `size-mismatch` | 340 | 98 | 20 | 104 | — |
| 231 | `src/overlays/o089/overlay89UpdateStateAndParticles.c` | `overlay89UpdateStateAndParticles` | `o089` | `size-mismatch` | 544 | 98 | 0 | 4 | — |
| 232 | `src/main/particles.c` | `func_8004054C` | `main` | `size-mismatch` | 500 | 101 | 44 | -4 | — |
| 233 | `src/overlays/o063/overlay63UpdateSequence.c` | `overlay63UpdateSequence` | `o063` | `size-mismatch` | 428 | 102 | 20 | -4 | — |
| 234 | `src/main/anim.c` | `func_80050BF4` | `main` | `size-mismatch` | 348 | 104 | 52 | 132 | — |
| 235 | `src/overlays/o026/func_overlay_026_F0000B18_187AF10.c` | `func_overlay_026_F0000B18_187AF10` | `o026` | `size-mismatch` | 524 | 104 | 44 | -32 | — |
| 236 | `src/overlays/o029/overlay29ProjectPoint.c` | `func_overlay_029_F0000EE0_187E190` | `o029` | `size-mismatch` | 484 | 104 | 0 | -28 | — |
| 237 | `src/overlays/o099/overlay99BuildHeightGrid.c` | `overlay99BuildHeightGrid` | `o099` | `size-mismatch` | 456 | 104 | 44 | 4 | — |
| 238 | `src/main/font.c` | `func_8004C690` | `main` | `size-mismatch` | 584 | 105 | 0 | -8 | — |
| 239 | `src/overlays/o068/overlay68RebuildSecondaryEntry.c` | `overlay68RebuildSecondaryEntry` | `o068` | `size-mismatch` | 488 | 105 | 0 | -8 | — |
| 240 | `src/main/weather_tail.c` | `func_8003C80C` | `main` | `size-mismatch` | 472 | 106 | 16 | -4 | — |
| 241 | `src/overlays/o001/overlay_001_tail.c` | `overlay1SolveAngleCandidates` | `o001` | `size-mismatch` | 556 | 111 | 112 | -24 | — |
| 242 | `src/overlays/o001/overlay_001_head.c` | `overlay1BuildObjectMappings` | `o001` | `size-mismatch` | 592 | 114 | 0 | -16 | — |
| 243 | `src/main/runlink.c` | `runlinkFreeCode` | `main` | `size-mismatch` | 736 | 117 | 0 | -4 | — |
| 244 | `src/main/matrix.c` | `func_8002AC84` | `main` | `size-mismatch` | 396 | 118 | 0 | 80 | — |
| 245 | `src/overlays/o008/overlay_008.c` | `func_overlay_008_F0002640_1860398` | `o008` | `size-mismatch` | 732 | 119 | 140 | -8 | — |
| 246 | `src/overlays/o041/overlay41ProcessEntry.c` | `func_overlay_041_F0001464_188879C` | `o041` | `size-mismatch` | 492 | 120 | 16 | 20 | — |
| 247 | `src/main/fx.c` | `func_800470B0` | `main` | `size-mismatch` | 596 | 121 | 68 | 4 | — |
| 248 | `src/main/track.c` | `func_8000D1B8` | `main` | `size-mismatch` | 512 | 121 | 4 | -16 | — |
| 249 | `src/overlays/o036/overlay36ChooseWeightedState.c` | `func_overlay_036_F0000A60_1883F18` | `o036` | `size-mismatch` | 680 | 122 | 44 | -8 | — |
| 250 | `src/overlays/o031/overlay31InitializeParticleAssets.c` | `func_overlay_031_F00002E8_187F808` | `o031` | `size-mismatch` | 528 | 123 | 16 | 4 | — |
| 251 | `src/overlays/o001/overlay_001_tail.c` | `overlay1AdvancePath` | `o001` | `size-mismatch` | 648 | 124 | 16 | 12 | — |
| 252 | `src/main/fx.c` | `func_80049000` | `main` | `size-mismatch` | 596 | 125 | 0 | 4 | — |
| 253 | `src/main/runlink.c` | `ProcessRelocationEntry` | `main` | `size-mismatch` | 584 | 126 | 0 | 4 | — |
| 254 | `src/overlays/o002/func_overlay_002_F0001A94_185888C.c` | `func_overlay_002_F0001A94_185888C` | `o002` | `size-mismatch` | 868 | 127 | 76 | -4 | — |
| 255 | `src/main/spranim.c` | `func_8001B798` | `main` | `size-mismatch` | 700 | 131 | 0 | -16 | — |
| 256 | `src/overlays/o060/func_overlay_060_F0002F54_18BCD2C.c` | `func_overlay_060_F0002F54_18BCD2C` | `o060` | `size-mismatch` | 888 | 131 | 100 | -4 | — |
| 257 | `src/overlays/o044/overlay44UpdateFrameCache.c` | `overlay44UpdateFrameCache` | `o044` | `size-mismatch` | 748 | 133 | 0 | -4 | — |
| 258 | `src/main/matrix.c` | `func_8002AE10` | `main` | `size-mismatch` | 348 | 138 | 0 | 208 | — |
| 259 | `src/overlays/o009/overlay_009.c` | `func_overlay_009_F0000CE4_186735C` | `o009` | `size-mismatch` | 648 | 138 | 40 | -16 | — |
| 260 | `src/overlays/o037/overlay37Render.c` | `overlay37RenderEffect` | `o037` | `size-mismatch` | 856 | 139 | 0 | -4 | — |
| 261 | `src/main/track.c` | `func_80010900` | `main` | `size-mismatch` | 588 | 143 | 4 | -8 | — |
| 262 | `src/overlays/o022/overlay22ResolvePlane.c` | `func_overlay_022_F0000A7C_1878B84` | `o022` | `size-mismatch` | 692 | 143 | 96 | -20 | — |
| 263 | `src/main/track.c` | `func_8000D3B8` | `main` | `size-mismatch` | 440 | 144 | 4 | 160 | — |
| 264 | `src/overlays/o015/overlay_015.c` | `overlay15InitStars` | `o015` | `size-mismatch` | 760 | 144 | 100 | -12 | — |
| 265 | `src/overlays/o054/overlay54Initialize.c` | `func_overlay_054_F0000000_189ECA0` | `o054` | `size-mismatch` | 972 | 144 | 84 | 4 | — |
| 266 | `src/main/sched.c` | `func_80030610` | `main` | `size-mismatch` | 768 | 148 | 0 | 8 | — |
| 267 | `src/main/fx.c` | `func_8004A10C` | `main` | `size-mismatch` | 628 | 155 | 0 | -4 | — |
| 268 | `src/main/models.c` | `func_80020B10` | `main` | `size-mismatch` | 636 | 156 | 0 | 4 | — |
| 269 | `src/main/track.c` | `func_80012658` | `main` | `size-mismatch` | 708 | 157 | 0 | -12 | — |
| 270 | `src/main/fx.c` | `func_80049E4C` | `main` | `size-mismatch` | 676 | 159 | 8 | -8 | — |
| 271 | `src/overlays/o008/overlay_008.c` | `func_overlay_008_F0001000_185ED58` | `o008` | `size-mismatch` | 660 | 159 | 8 | -4 | — |
| 272 | `src/overlays/o008/overlay_008.c` | `func_overlay_008_F0004CF0_1862A48` | `o008` | `size-mismatch` | 1,080 | 159 | 44 | -8 | — |
| 273 | `src/overlays/o001/overlay_001_tail.c` | `func_overlay_001_F0003FD8_18503B8` | `o001` | `size-mismatch` | 948 | 162 | 32 | -12 | — |
| 274 | `src/overlays/o079/func_overlay_079_F0000FA0_18CDF40.c` | `func_overlay_079_F0000FA0_18CDF40` | `o079` | `size-mismatch` | 736 | 162 | 56 | -44 | — |
| 275 | `src/main/track.c` | `func_80010654` | `main` | `size-mismatch` | 684 | 163 | 0 | 4 | — |
| 276 | `src/overlays/o013/overlay13DrawActive.c` | `overlay13DrawActive` | `o013` | `size-mismatch` | 664 | 163 | 0 | -4 | — |
| 277 | `src/main/lights.c` | `func_80018F08` | `main` | `size-mismatch` | 820 | 166 | 0 | -24 | — |
| 278 | `src/overlays/o034/overlay34SortAndDraw.c` | `overlay34SortAndDraw` | `o034` | `size-mismatch` | 760 | 168 | 0 | -4 | — |
| 279 | `src/overlays/o101/overlay101BuildPresentationA.c` | `overlay101BuildPresentationA` | `o101` | `size-mismatch` | 832 | 169 | 16 | 4 | — |
| 280 | `src/overlays/o101/overlay101BuildPresentationB.c` | `overlay101BuildPresentationB` | `o101` | `size-mismatch` | 832 | 169 | 16 | 4 | — |
| 281 | `src/overlays/o101/overlay101BuildPresentationC.c` | `overlay101BuildPresentationC` | `o101` | `size-mismatch` | 832 | 169 | 16 | 4 | — |
| 282 | `src/overlays/o038/overlay38UpdateParticles.c` | `func_overlay_038_F0000154_1885E64` | `o038` | `size-mismatch` | 808 | 171 | 32 | -8 | — |
| 283 | `src/main/fx.c` | `func_80047304` | `main` | `size-mismatch` | 740 | 176 | 4 | -8 | — |
| 284 | `src/main/fx.c` | `func_800479D4` | `main` | `size-mismatch` | 772 | 176 | 56 | -56 | — |
| 285 | `src/main/fx.c` | `wakeDraw` | `main` | `size-mismatch` | 708 | 177 | 0 | -56 | — |
| 286 | `src/main/track.c` | `func_800103D4` | `main` | `size-mismatch` | 640 | 177 | 0 | 68 | — |
| 287 | `src/overlays/o020/overlay20UpdateGrid.c` | `overlay20UpdateGrid` | `o020` | `size-mismatch` | 860 | 177 | 0 | -4 | — |
| 288 | `src/main/lights.c` | `func_80019AB8` | `main` | `size-mismatch` | 736 | 178 | 0 | 28 | — |
| 289 | `src/overlays/o038/func_overlay_038_F000047C_188618C.c` | `func_overlay_038_F000047C_188618C` | `o038` | `size-mismatch` | 876 | 178 | 0 | -4 | — |
| 290 | `src/main/shadows.c` | `func_800180B4` | `main` | `size-mismatch` | 824 | 179 | 52 | -8 | — |
| 291 | `src/overlays/o001/overlay_001_tail.c` | `overlay1UpdateAimedTransient` | `o001` | `size-mismatch` | 996 | 184 | 0 | -16 | — |
| 292 | `src/overlays/o011/func_overlay_011_F0001E4C_186A694.c` | `func_overlay_011_F0001E4C_186A694` | `o011` | `size-mismatch` | 1,180 | 189 | 216 | -4 | — |
| 293 | `src/main/menu.c` | `func_80039E34` | `main` | `size-mismatch` | 1,048 | 190 | 20 | 8 | — |
| 294 | `src/overlays/o020/func_overlay_020_F0001148_1877720.c` | `func_overlay_020_F0001148_1877720` | `o020` | `size-mismatch` | 828 | 195 | 32 | -12 | — |
| 295 | `src/overlays/o066/func_overlay_066_F00004E0_18C6948.c` | `func_overlay_066_F00004E0_18C6948` | `o066` | `size-mismatch` | 816 | 202 | 0 | -52 | — |
| 296 | `src/main/anim.c` | `func_800573C8` | `main` | `size-mismatch` | 932 | 203 | 44 | -8 | — |
| 297 | `src/overlays/o100/overlay100DrawMotion.c` | `overlay100DrawMotion` | `o100` | `size-mismatch` | 972 | 204 | 0 | -20 | — |
| 298 | `src/main/charControl.c` | `func_8001D960` | `main` | `size-mismatch` | 880 | 205 | 0 | -4 | — |
| 299 | `src/overlays/o099/overlay99ApplySegment.c` | `overlay99ApplySegment` | `o099` | `size-mismatch` | 920 | 206 | 0 | -4 | — |
| 300 | `src/main/track.c` | `func_80012234` | `main` | `size-mismatch` | 832 | 208 | 0 | -176 | — |
| 301 | `src/main/track.c` | `func_80011980` | `main` | `size-mismatch` | 860 | 209 | 0 | -12 | — |
| 302 | `src/overlays/o009/overlay_009.c` | `func_overlay_009_F00010B4_186772C` | `o009` | `size-mismatch` | 1,128 | 213 | 136 | -20 | — |
| 303 | `src/main/anim.c` | `func_80056DD8` | `main` | `size-mismatch` | 916 | 214 | 0 | -12 | — |
| 304 | `src/main/fx.c` | `func_80049B14` | `main` | `size-mismatch` | 824 | 216 | 8 | 52 | — |
| 305 | `src/main/fx.c` | `fxSPDPRipple` | `main` | `size-mismatch` | 928 | 226 | 8 | 16 | — |
| 306 | `src/main/track.c` | `func_8000F198` | `main` | `size-mismatch` | 996 | 228 | 0 | -8 | — |
| 307 | `src/main/particles.c` | `func_80040B88` | `main` | `size-mismatch` | 1,208 | 231 | 0 | -8 | — |
| 308 | `src/main/track.c` | `func_800115E4` | `main` | `size-mismatch` | 924 | 231 | 0 | -12 | — |
| 309 | `src/overlays/o015/overlay_015.c` | `overlay15InitStarsAndPalette` | `o015` | `size-mismatch` | 988 | 231 | 4 | -4 | — |
| 310 | `src/main/charControl.c` | `func_8001EC44` | `main` | `size-mismatch` | 952 | 233 | 0 | -28 | — |
| 311 | `src/overlays/o029/overlay29HandleEffects.c` | `func_overlay_029_F00010C4_187E374` | `o029` | `size-mismatch` | 1,028 | 235 | 44 | -4 | — |
| 312 | `src/main/camera.c` | `func_80023598` | `main` | `size-mismatch` | 1,136 | 243 | 0 | 4 | — |
| 313 | `src/overlays/o026/overlay26HandleEffects.c` | `func_overlay_026_F0000D24_187B11C` | `o026` | `size-mismatch` | 1,076 | 248 | 44 | -4 | — |
| 314 | `src/overlays/o020/func_overlay_020_F000038C_1876964.c` | `func_overlay_020_F000038C_1876964` | `o020` | `size-mismatch` | 1,080 | 262 | 0 | -24 | — |
| 315 | `src/main/lights.c` | `func_8001953C` | `main` | `size-mismatch` | 1,016 | 264 | 0 | 180 | — |
| 316 | `src/main/track.c` | `func_8000DB34` | `main` | `size-mismatch` | 688 | 267 | 0 | 380 | — |
| 317 | `src/overlays/o101/overlay101TailA6BC.c` | `overlay101TailA6BC` | `o101` | `size-mismatch` | 1,168 | 268 | 0 | -8 | — |
| 318 | `src/overlays/o101/func_overlay_101_F0002510_18DDD30.c` | `func_overlay_101_F0002510_18DDD30` | `o101` | `size-mismatch` | 1,172 | 276 | 0 | -52 | — |
| 319 | `src/overlays/o057/func_overlay_057_F00060F8_18A9CF0.c` | `func_overlay_057_F00060F8_18A9CF0` | `o057` | `size-mismatch` | 1,764 | 278 | 0 | -16 | — |
| 320 | `src/main/track.c` | `func_8000E5EC` | `main` | `size-mismatch` | 820 | 283 | 0 | 312 | — |
| 321 | `src/overlays/o008/overlay_008.c` | `func_overlay_008_F000291C_1860674` | `o008` | `size-mismatch` | 1,444 | 297 | 0 | -28 | — |
| 322 | `src/main/models.c` | `func_8001FC50` | `main` | `size-mismatch` | 1,332 | 300 | 0 | -12 | — |
| 323 | `src/overlays/o071/func_overlay_071_F0000278_18C9D98.c` | `func_overlay_071_F0000278_18C9D98` | `o071` | `size-mismatch` | 1,328 | 302 | 112 | -4 | — |
| 324 | `src/overlays/o043/func_overlay_043_F0000BE4_188ABB4.c` | `func_overlay_043_F0000BE4_188ABB4` | `o043` | `size-mismatch` | 1,220 | 309 | 4 | 28 | — |
| 325 | `src/main/rcpFast3d.c` | `func_8002F618` | `main` | `size-mismatch` | 1,308 | 312 | 52 | -156 | — |
| 326 | `src/main/shadows.c` | `func_80017BCC` | `main` | `size-mismatch` | 1,256 | 313 | 0 | 48 | — |
| 327 | `src/main/track.c` | `func_8001357C` | `main` | `size-mismatch` | 1,040 | 314 | 0 | 276 | — |
| 328 | `src/overlays/o012/func_overlay_012_F00003A8_186D628.c` | `func_overlay_012_F00003A8_186D628` | `o012` | `size-mismatch` | 1,384 | 318 | 16 | -32 | — |
| 329 | `src/main/diCpu.c` | `render_epc_lock_up_display` | `main` | `size-mismatch` | 1,376 | 321 | 60 | 12 | — |
| 330 | `src/overlays/o044/func_overlay_044_F0000580_188BDE0.c` | `func_overlay_044_F0000580_188BDE0` | `o044` | `size-mismatch` | 1,396 | 329 | 0 | -8 | — |
| 331 | `src/overlays/o087/func_overlay_087_F0000128_18D3090.c` | `func_overlay_087_F0000128_18D3090` | `o087` | `size-mismatch` | 1,896 | 331 | 44 | -44 | — |
| 332 | `src/overlays/o092/func_overlay_092_F0000308_18D6228.c` | `func_overlay_092_F0000308_18D6228` | `o092` | `size-mismatch` | 1,832 | 331 | 112 | -8 | — |
| 333 | `src/main/track.c` | `func_80011CDC` | `main` | `size-mismatch` | 1,368 | 335 | 0 | -64 | — |
| 334 | `src/main/shadows.c` | `func_80017140` | `main` | `size-mismatch` | 1,312 | 337 | 0 | 64 | — |
| 335 | `src/main/camera.c` | `func_80022FD4` | `main` | `size-mismatch` | 1,476 | 338 | 44 | -28 | — |
| 336 | `src/main/fx.c` | `wakeAllocate` | `main` | `size-mismatch` | 1,404 | 340 | 12 | -232 | — |
| 337 | `src/main/track.c` | `func_8000BDB4` | `main` | `size-mismatch` | 1,612 | 342 | 48 | -40 | — |
| 338 | `src/main/rcpFast3d.c` | `func_8002FB34` | `main` | `size-mismatch` | 1,436 | 358 | 0 | -16 | — |
| 339 | `src/main/track.c` | `func_8001398C` | `main` | `size-mismatch` | 1,320 | 365 | 0 | 156 | — |
| 340 | `src/overlays/o001/overlay_001_tail.c` | `func_overlay_001_F0003750_184FB30` | `o001` | `size-mismatch` | 1,784 | 366 | 12 | 4 | — |
| 341 | `src/main/anim.c` | `func_80054B3C` | `main` | `size-mismatch` | 1,480 | 368 | 0 | -112 | — |
| 342 | `src/main/shadows.c` | `func_80017660` | `main` | `size-mismatch` | 1,388 | 368 | 0 | 92 | — |
| 343 | `src/overlays/o057/func_overlay_057_F0000000_18A3BF8.c` | `func_overlay_057_F0000000_18A3BF8` | `o057` | `size-mismatch` | 2,388 | 371 | 8 | -12 | — |
| 344 | `src/main/main.c` | `func_80026FB4` | `main` | `size-mismatch` | 1,652 | 375 | 8 | -76 | — |
| 345 | `src/main/track.c` | `func_8000DFBC` | `main` | `size-mismatch` | 1,584 | 380 | 0 | -164 | — |
| 346 | `src/main/fx.c` | `wakeUpdate` | `main` | `size-mismatch` | 1,592 | 386 | 0 | -72 | — |
| 347 | `src/overlays/o046/func_overlay_046_F0000874_188EC6C.c` | `func_overlay_046_F0000874_188EC6C` | `o046` | `size-mismatch` | 1,800 | 388 | 0 | 4 | — |
| 348 | `src/main/fx.c` | `func_800475E8` | `main` | `size-mismatch` | 1,004 | 390 | 0 | 780 | — |
| 349 | `src/overlays/o008/overlay_008.c` | `func_overlay_008_F00042A8_1862000` | `o008` | `size-mismatch` | 1,788 | 390 | 68 | -100 | — |
| 350 | `src/overlays/o035/func_overlay_035_F00001E0_1881EC0.c` | `func_overlay_035_F00001E0_1881EC0` | `o035` | `size-mismatch` | 1,424 | 392 | 0 | 168 | — |
| 351 | `src/main/models.c` | `func_8001F520` | `main` | `size-mismatch` | 1,604 | 394 | 8 | -228 | — |
| 352 | `src/overlays/o041/overlay41UpdateCurveObject.c` | `func_overlay_041_F0000854_1887B8C` | `o041` | `size-mismatch` | 2,552 | 399 | 52 | -8 | — |
| 353 | `src/main/particles.c` | `func_80041530` | `main` | `size-mismatch` | 1,824 | 427 | 0 | -280 | — |
| 354 | `src/main/main.c` | `func_80028564` | `main` | `size-mismatch` | 1,956 | 430 | 40 | -88 | — |
| 355 | `src/main/diCpu.c` | `func_80045D34` | `main` | `size-mismatch` | 1,836 | 440 | 0 | -28 | — |
| 356 | `src/overlays/o029/func_overlay_029_F00005C4_187D874.c` | `func_overlay_029_F00005C4_187D874` | `o029` | `size-mismatch` | 2,332 | 441 | 4 | -20 | — |
| 357 | `src/overlays/o002/func_overlay_002_F0001DF8_1858BF0.c` | `func_overlay_002_F0001DF8_1858BF0` | `o002` | `size-mismatch` | 1,840 | 448 | 4 | -20 | — |
| 358 | `src/overlays/o057/func_overlay_057_F0004460_18A8058.c` | `func_overlay_057_F0004460_18A8058` | `o057` | `size-mismatch` | 1,976 | 450 | 4 | -144 | — |
| 359 | `src/overlays/o084/func_overlay_084_F0000314_18D07F4.c` | `func_overlay_084_F0000314_18D07F4` | `o084` | `size-mismatch` | 1,856 | 450 | 60 | 16 | — |
| 360 | `src/overlays/o101/func_overlay_101_F0008128_18E3948.c` | `func_overlay_101_F0008128_18E3948` | `o101` | `size-mismatch` | 2,100 | 472 | 4 | -4 | — |
| 361 | `src/overlays/o101/func_overlay_101_F000895C_18E417C.c` | `func_overlay_101_F000895C_18E417C` | `o101` | `size-mismatch` | 2,100 | 472 | 4 | -4 | — |
| 362 | `src/overlays/o101/func_overlay_101_F0009190_18E49B0.c` | `func_overlay_101_F0009190_18E49B0` | `o101` | `size-mismatch` | 2,100 | 472 | 4 | -4 | — |
| 363 | `src/overlays/o046/func_overlay_046_F0001228_188F620.c` | `func_overlay_046_F0001228_188F620` | `o046` | `size-mismatch` | 1,844 | 477 | 0 | 236 | — |
| 364 | `src/overlays/o101/func_overlay_101_F00078F4_18E3114.c` | `func_overlay_101_F00078F4_18E3114` | `o101` | `size-mismatch` | 2,100 | 480 | 4 | -4 | — |
| 365 | `src/overlays/o008/overlay_008.c` | `func_overlay_008_F0000058_185DDB0` | `o008` | `size-mismatch` | 2,108 | 482 | 0 | -76 | — |
| 366 | `src/main/shadows.c` | `shadowGenerate` | `main` | `size-mismatch` | 2,040 | 490 | 12 | -220 | — |
| 367 | `src/overlays/o001/overlay_001_head.c` | `overlay1LoadBuildRecords` | `o001` | `size-mismatch` | 2,288 | 491 | 52 | -92 | — |
| 368 | `src/overlays/o022/func_overlay_022_F00002B0_18783B8.c` | `func_overlay_022_F00002B0_18783B8` | `o022` | `size-mismatch` | 1,996 | 492 | 4 | -36 | — |
| 369 | `src/overlays/o035/func_overlay_035_F0000B40_1882820.c` | `func_overlay_035_F0000B40_1882820` | `o035` | `size-mismatch` | 2,112 | 493 | 4 | -68 | — |
| 370 | `src/main/font.c` | `func_8004B1DC` | `main` | `size-mismatch` | 2,224 | 509 | 48 | -112 | — |
| 371 | `src/overlays/o019/overlay19BuildPlanes.c` | `overlay19BuildPlanes` | `o019` | `size-mismatch` | 2,128 | 514 | 72 | -32 | — |
| 372 | `src/overlays/o043/func_overlay_043_F0000324_188A2F4.c` | `func_overlay_043_F0000324_188A2F4` | `o043` | `size-mismatch` | 2,240 | 529 | 64 | -12 | — |
| 373 | `src/main/track.c` | `func_8000E920` | `main` | `size-mismatch` | 2,168 | 536 | 56 | 48 | — |
| 374 | `src/overlays/o011/func_overlay_011_F0000150_1868998.c` | `func_overlay_011_F0000150_1868998` | `o011` | `size-mismatch` | 2,248 | 538 | 0 | -120 | — |
| 375 | `src/overlays/o055/func_overlay_055_F000031C_18A1E34.c` | `func_overlay_055_F000031C_18A1E34` | `o055` | `size-mismatch` | 2,324 | 540 | 60 | -156 | — |
| 376 | `src/main/track.c` | `func_8001291C` | `main` | `size-mismatch` | 2,192 | 543 | 0 | -136 | — |
| 377 | `src/main/shadows.c` | `func_80016890` | `main` | `size-mismatch` | 2,224 | 556 | 0 | -188 | — |
| 378 | `src/overlays/o026/func_overlay_026_F00001A0_187A598.c` | `func_overlay_026_F00001A0_187A598` | `o026` | `size-mismatch` | 2,424 | 560 | 156 | -20 | — |
| 379 | `src/overlays/o090/overlay_090.c` | `func_overlay_090_F00000FC_18D4BF4` | `o090` | `size-mismatch` | 2,592 | 575 | 0 | -36 | — |
| 380 | `src/overlays/o045/func_overlay_045_F0000764_188CBBC.c` | `func_overlay_045_F0000764_188CBBC` | `o045` | `size-mismatch` | 2,548 | 580 | 208 | -20 | — |
| 381 | `src/overlays/o012/func_overlay_012_F0000910_186DB90.c` | `func_overlay_012_F0000910_186DB90` | `o012` | `size-mismatch` | 2,444 | 584 | 0 | -24 | — |
| 382 | `src/overlays/o057/func_overlay_057_F0001020_18A4C18.c` | `func_overlay_057_F0001020_18A4C18` | `o057` | `size-mismatch` | 2,392 | 585 | 0 | -32 | — |
| 383 | `src/overlays/o045/func_overlay_045_F0001158_188D5B0.c` | `func_overlay_045_F0001158_188D5B0` | `o045` | `size-mismatch` | 2,696 | 593 | 0 | 28 | — |
| 384 | `src/overlays/o101/overlay101TailAB4C.c` | `func_overlay_101_F000AB4C_18E636C` | `o101` | `size-mismatch` | 2,552 | 636 | 4 | 108 | — |
| 385 | `src/main/track.c` | `func_80010B4C` | `main` | `size-mismatch` | 2,712 | 677 | 4 | -136 | — |
| 386 | `src/overlays/o047/func_overlay_047_F0000000_1890E18.c` | `func_overlay_047_F0000000_1890E18` | `o047` | `size-mismatch` | 2,512 | 680 | 0 | 500 | — |
| 387 | `src/overlays/o065/overlay65UpdateParticles.c` | `overlay65UpdateParticles` | `o065` | `size-mismatch` | 2,880 | 696 | 12 | -40 | — |
| 388 | `src/main/vehicle_sounds.c` | `func_8005830C` | `main` | `size-mismatch` | 3,048 | 706 | 0 | -20 | — |
| 389 | `src/overlays/o053/func_overlay_053_F0000240_189DBE8.c` | `func_overlay_053_F0000240_189DBE8` | `o053` | `size-mismatch` | 2,544 | 710 | 0 | 308 | — |
| 390 | `src/overlays/o058/func_overlay_058_F00005FC_18AF7E4.c` | `func_overlay_058_F00005FC_18AF7E4` | `o058` | `size-mismatch` | 3,316 | 824 | 0 | -16 | — |
| 391 | `src/overlays/o101/func_overlay_101_F00069E8_18E2208.c` | `func_overlay_101_F00069E8_18E2208` | `o101` | `size-mismatch` | 3,852 | 850 | 44 | 16 | — |
| 392 | `src/overlays/o079/func_overlay_079_F0000134_18CD0D4.c` | `func_overlay_079_F0000134_18CD0D4` | `o079` | `size-mismatch` | 3,528 | 854 | 4 | -84 | — |
| 393 | `src/overlays/o008/overlay_008.c` | `func_overlay_008_F00034A0_18611F8` | `o008` | `size-mismatch` | 3,592 | 988 | 0 | 404 | — |
| 394 | `src/overlays/o101/func_overlay_101_F0003A58_18DF278.c` | `func_overlay_101_F0003A58_18DF278` | `o101` | `size-mismatch` | 5,844 | 1,396 | 52 | 8 | — |
| 395 | `src/overlays/o001/overlay_001_tail.c` | `func_overlay_001_F000438C_185076C` | `o001` | `size-mismatch` | 6,168 | 1,502 | 0 | 172 | — |
| 396 | `src/overlays/o050/func_overlay_050_F0000334_1896CA4.c` | `func_overlay_050_F0000334_1896CA4` | `o050` | `size-mismatch` | 6,300 | 2,531 | 0 | 3,864 | — |
| 397 | `src/overlays/o047/func_overlay_047_F0000B30_1891948.c` | `func_overlay_047_F0000B30_1891948` | `o047` | `size-mismatch` | 8,672 | 2,701 | 0 | 2,176 | — |
| 398 | `src/overlays/o058/func_overlay_058_F000138C_18B0574.c` | `func_overlay_058_F000138C_18B0574` | `o058` | `size-mismatch` | 14,456 | 3,579 | 0 | -1,000 | — |
