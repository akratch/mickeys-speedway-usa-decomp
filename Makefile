...
LIBULTRA_O2_G3_TUS := epidma epilinkhandle epirawdma epirawread epirawwrite \
                      epiread epiwrite pfsallocatefile pfsfilestate \
                      pfsfreeblocks pfsgetstatus pfsinit pfsisplug pfsnumfiles \
                      pfsreadwritefile pfssearchfile pfsselectbank piacs pidma \
                      pigetcmdq pirawdma
