/*
 * Mickey's EEPROM read TU retains the official SDK packet construction and
 ...
 * Kazooie decomp at `lib/ultralib/src/io/conteepread.c`, pinned in
...
void func_800736EC(u8 address);

s32 func_80073490(OSMesgQueue *mq, u8 address, u8 *buffer) {
    s32 ret = 0;
    int i = 0;
    u16 type;
    u8 *ptr;
