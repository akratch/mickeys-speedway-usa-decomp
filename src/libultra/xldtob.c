 ...
 * src/libc/xldtob.c. Mickey's whole text and rodata object is independently
 * compiler- and link-exact.
 *
 * Flags: DKR's measured -O3 -mips2 -Wab,-r4300_mul -w preset, compiled
