/*
 * libultra: is a Controller Pak present, changed, or failing on this channel?
 *
 * ROM 0x6DBD0-0x6DE10 (VRAM 0x8006CFD0). Byte-identical to Jet Force Gemini's
 * built libultra `io/pfsgetstatus.c` object, so the file boundary is measured
