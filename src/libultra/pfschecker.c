/*
 * libultra: walk the pak's directory and inode tables and repair what is
 * inconsistent.
 *
 * ROM 0x6EA30-0x6F3E0 (VRAM 0x8006DE30). Byte-identical to Jet Force Gemini's
 * built libultra `io/pfschecker.c` object, so the file boundary is measured
