...
#define NULL_PARAMS_N D_80080180
...
u32 D_800801A8 [6] = {
    0, 0, 0, 0xC1200000, 0, 0
};

#define M_PI    3.141592741f

void func_80064DC0(f32 outputrate, f32 arg1, f32 arg2, f32 *arg3, f32 *arg4)
{
	f32 sp24;
	f32 sp20;
	f32 sp1c;
...
void n_alFxInitlpfilter_mono(struct fx *fx, f32 outputrate)
{
	...
	func_80064DC0(outputrate, fx->unk00 + 10.0f, fx->unk02 / 10.0f, sp30, sp24);
