 ...
 * lib/ultralib/src/io/contramread.c:__osContRamRead. Mickey's existing
...
// PROVENANCE: adapted from banjo-kazooie lib/ultralib/src/io/contramread.c:__osContRamRead
