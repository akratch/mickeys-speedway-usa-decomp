/*
 * libultra: report one directory entry's size, codes and names.
 *
 * ROM 0x6CAC0-0x6CCA0 (VRAM 0x8006BEC0). Byte-identical to Jet Force Gemini's
 * built libultra `io/pfsfilestate.c` object, so the file boundary is measured
