...
/* Plateau: workbench allocation-mismatch; 10/88 words differ, first +0x54,
 * with 33 relocation sites unresolved. Ownership: typed resource tables emit
 * the exact 0x5A0 block; remaining blocker is overlay-local address binding. */
#ifdef NON_MATCHING
