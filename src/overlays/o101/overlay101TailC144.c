...
/* Packet-local role names only; the relocation ledger has not proved real
 * callee identities or any relationship to A6BC/B544 helpers. */
extern void *o101TailC144CreatorReloc(s32 kind, void *source, s32 value);
extern void o101TailC144FinalizerReloc(void *object);
...
void func_overlay_101_F000C144_18E7964(void) {
    ...
    orderIndex = gO101TailC144OrderCount;
    ...
    gO101TailC144OrderCount = orderIndex + 1;
    ...
    node32->scale = 1.0f;
    node32->value14 = 0.0f;
    handle = o101TailC144CreatorReloc(0x93, NULL, 0xFF);
    ...
    node24->x = 0x66;
    node24->y = 0x10;
    length = overlay101ByteLength(gO101TailC144Inputs.text1B0);
    nodeIndex = gO101TailC144Node24Count;
    node24 = &gO101TailC144Nodes24[nodeIndex];
    ...
    node24->x = 0x66;
    node24->y = 0x1E;
    length = overlay101ByteLength(gO101TailC144Inputs.text1B4);
    nodeIndex = gO101TailC144Node24Count;
    node24 = &gO101TailC144Nodes24[nodeIndex];
    node24->length = (u8)length;
    node24->opacity = (s8)(s32)((f32)(u32)(length & 0xFF) * scale);
    ...
    node24->x = 0x66;
    node24->y = 0x28;
    length = overlay101ByteLength(gO101TailC144Inputs.text1B8);
    nodeIndex = gO101TailC144Node24Count;
    node24 = &gO101TailC144Nodes24[nodeIndex];
    node24->length = (u8)length;
    node24->opacity = (s8)(s32)((f32)(u32)(length & 0xFF) * scale);
    ...
    node24->x = 0x66;
    node24->y = 0x36;
    length = overlay101ByteLength(gO101TailC144Inputs.text1BC);
    nodeIndex = gO101TailC144Node24Count;
    node24 = &gO101TailC144Nodes24[nodeIndex];
    node24->length = (u8)length;
    node24->opacity = (s8)(s32)((f32)(u32)(length & 0xFF) * scale);
    ...
    node24->x = 0x66;
    node24->y = 0x40;
    length = overlay101ByteLength(gO101TailC144Inputs.text1C0);
    nodeIndex = gO101TailC144Node24Count;
    node24 = &gO101TailC144Nodes24[nodeIndex];
    node24->length = (u8)length;
    node24->opacity = (s8)(s32)((f32)(u32)(length & 0xFF) * scale);
