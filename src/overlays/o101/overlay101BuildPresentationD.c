...
void overlay101BuildPresentationD(void) {
    ...
    gOverlay101BuilderRoot.asset34 = &gOverlay101BuilderAssetD;
    ...
    compactSelector = 0x18;
    gOverlay101BuilderRoot.width44 = compactSelector;
    gOverlay101BuilderRoot.height48 = compactSelector;
    ...
    node24A->x = 0x50;
    node24A->y = 0x9C;
    length = overlay101ByteLength(gOverlay101BuilderInput148);
