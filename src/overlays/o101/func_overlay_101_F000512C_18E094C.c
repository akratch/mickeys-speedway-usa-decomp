...
#define ADD_TEXT_ROW(field, rowY)                                            \
    ...
    ADD_TEXT_ROW(text78, 0x28);
    ADD_TEXT_ROW(text7C, 0x36);

#undef ADD_TEXT_ROW

    func_overlay_101_F0000000_18DB820(&D_CE0);
}
#else
#pragma GLOBAL_ASM("asm/nonmatchings/overlays/o101/func_overlay_101_F000512C_18E094C/func_overlay_101_F000512C_18E094C.s")
#endif
