...
typedef struct Overlay88Object { u8 pad0[0x64]; Overlay88State *state; } Overlay88Object;

void overlay88Init(Overlay88Object *object, s32 unused) {
    Overlay88State *state = object->state;
