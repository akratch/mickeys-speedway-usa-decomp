...
/* Plateau (near-miss batch 13): -O2 -mips2 is size/opcode-exact; 21/39 words
 * differ, first +0x10. Pointer/storage/expression forms tied or regressed;
 * the 40-minute permuter retained artificial nonzero score 155. */
#ifdef NON_MATCHING
