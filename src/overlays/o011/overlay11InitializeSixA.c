...
void overlay11InitializeSixA(void) {
    gOverlay11Created[0] = overlay11CreateReloc(
        gOverlay11Resources->resource1AC, 160, 40, 4);
    gOverlay11Created[1] = overlay11CreateReloc(
        gOverlay11Resources->resource19C, 160, 80, 4);
    gOverlay11Created[2] = overlay11CreateReloc(
        gOverlay11Resources->resource1A8, 160, 110, 4);
    gOverlay11Created[3] = overlay11CreateReloc(
        gOverlay11Resources->resource94, 160, 140, 4);
    gOverlay11Created[4] = overlay11CreateReloc(
        gOverlay11Resources->resource98, 160, 170, 4);
    gOverlay11Created[5] = overlay11CreateReloc(
        gOverlay11Resources->resource50, 160, 200, 4);
