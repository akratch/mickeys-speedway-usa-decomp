...
void overlay29RotateBackward(s32 count) {
    while (count--) {
        gOverlay29Value3 = gOverlay29Value2;
        gOverlay29Value2 = gOverlay29Value1;
        gOverlay29Value1 = gOverlay29Value0;
        gOverlay29Value0 = overlay29AdvanceReloc(gOverlay29Value0);
    }
