...
/* Workbench: words-identical; the measured diprint BSS owner fixes placement.
 * Strict object comparison still leaves D_800D4A62 versus D_800D4A60+2. */
...
/* Workbench: words-identical; diprint owns the measured BSS and rodata ranges.
 * The linked ROM oracle is exact; asm-object aliases remain compiler-local. */
s32 debug_text_parse(Gfx **dList, char *buffer) {
    char *bufferCopy;
    s32 xOffset;
    u8 red;
