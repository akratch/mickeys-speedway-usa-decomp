#!/usr/bin/env python3
"""Fail-loud expansion of the natural O1 +10C8 semantic candidate."""
...
EXPECTED_TEXT = "71d49409b91e102a5be800af5d31e6b662278827589293481279da4971a12db2"
...
# Preserve the three natural alignment nops and append 20 zero instructions.
# Together they are the complete 23-word representation pool needed to cover
# the target's extra natural instructions; the schedule web must consume every
# word and prove the final owned digest.
