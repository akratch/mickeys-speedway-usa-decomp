...
[![functions](https://img.shields.io/badge/functions_matched-176_of_1461_(12.05%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-329272_of_950236_(34.65%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-488_adopted-blue)](#progress)

```
functions      176 / 1461    12.05%   matched to C, byte-identical
.text bytes  35616 / 480972   7.41%   matched C in the resident segment
verified asm  17104 / 480972   3.56%   original hand-written assembly (83 functions)
overlay C   276552 / 469264  58.93%   matched C keyed by overlay and offset
whole resolved 329272 / 950236  34.65%   resident C + verified asm + overlay C
...
```
decompiled              312168 / 950236  (32.85%)
handwritten asm          17104 / 950236  ( 1.80%)
GLOBAL_ASM remaining    620916 / 950236  (65.34%)
NON_MATCHING                48 / 950236  ( 0.01%)
NON_EQUIVALENT               0 / 950236  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 299 | 169 | 102 | 28 | `███████████▓▓▓▓▓▓▓░░` 90.6% |
| game code, TU identified | 114 | 7 | 73 | 34 | `█▓▓▓▓▓▓▓▓▓▓▓▓▓░░░░░░` 70.2% |
| game code, not yet split | 1048 | 0 | 57 | 991 | `▓░░░░░░░░░░░░░░░░░░░` 5.4% |
| **total** | 1461 | 176 | 232 | 1053 | `██▓▓▓▓░░░░░░░░░░░░░░` 27.9% |
