...
[![functions](https://img.shields.io/badge/functions_matched-663_of_1459_(45.44%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-208440_of_947932_(21.99%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1025_adopted-blue)](#progress)

```
functions      663 / 1459    45.44%   matched to C, byte-identical
.text bytes 117912 / 478668  24.63%   matched C in the resident segment
verified asm  17104 / 478668   3.57%   original hand-written assembly (83 functions)
overlay C    73424 / 469264  15.65%   matched C keyed by overlay and offset
whole resolved 208440 / 947932  21.99%   resident C + verified asm + overlay C
...
```
decompiled              191336 / 947932  (20.18%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    519540 / 947932  (54.81%)
NON_MATCHING            219952 / 947932  (23.20%)
