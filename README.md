...
[![functions](https://img.shields.io/badge/functions_matched-965_of_1464_(65.92%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319736_of_947832_(33.73%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1210_adopted-blue)](#progress)

```
functions      965 / 1464    65.92%   matched to C, byte-identical
.text bytes 198520 / 478568  41.48%   matched C in the resident segment
...
whole resolved 319736 / 947832  33.73%   resident C + verified asm + overlay C
named         1109 / 1464    75.75%   functions carrying an adopted name
...
```
decompiled              302632 / 947832  (31.93%)
handwritten asm          17104 / 947832  ( 1.80%)
GLOBAL_ASM remaining    308344 / 947832  (32.53%)
...
| game code, TU identified | 991 | 719 | 95 | 177 | `███████████████▓░░░░` 82.1% |
| game code, not yet split | 184 | 0 | 9 | 175 | `▓░░░░░░░░░░░░░░░░░░░` 4.9% |
| **total** | 1464 | 965 | 144 | 355 | `█████████████▓▓░░░░░` 75.8% |
