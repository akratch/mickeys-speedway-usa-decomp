...
[![functions](https://img.shields.io/badge/functions_matched-131_of_1468_(8.92%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319732_of_950348_(33.64%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-485_adopted-blue)](#progress)

```
functions      131 / 1468     8.92%   matched to C, byte-identical
.text bytes  26076 / 481084   5.42%   matched C in the resident segment
...
whole resolved 319732 / 950348  33.64%   resident C + verified asm + overlay C
...
```
decompiled              302628 / 950348  (31.84%)
handwritten asm          17104 / 950348  ( 1.80%)
GLOBAL_ASM remaining    630568 / 950348  (66.35%)
...
| game code, TU identified | 137 | 14 | 75 | 48 | `██▓▓▓▓▓▓▓▓▓▓▓░░░░░░░` 65.0% |
