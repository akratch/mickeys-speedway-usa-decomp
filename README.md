...
[![functions](https://img.shields.io/badge/functions_matched-675_of_1459_(46.26%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-210068_of_947932_(22.16%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1025_adopted-blue)](#progress)

```
functions      675 / 1459    46.26%   matched to C, byte-identical
.text bytes 120476 / 478668  25.17%   matched C in the resident segment
...
whole resolved 210068 / 947932  22.16%   resident C + verified asm + overlay C
...
```
decompiled              192964 / 947932  (20.36%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    516976 / 947932  (54.54%)
