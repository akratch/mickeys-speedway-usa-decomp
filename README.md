...
[![functions](https://img.shields.io/badge/functions_matched-179_of_1461_(12.25%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-332164_of_950232_(34.96%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-488_adopted-blue)](#progress)

```
functions      179 / 1461    12.25%   matched to C, byte-identical
.text bytes  38508 / 480968   8.01%   matched C in the resident segment
verified asm  17104 / 480968   3.56%   original hand-written assembly (83 functions)
overlay C   276552 / 469264  58.93%   matched C keyed by overlay and offset
whole resolved 332164 / 950232  34.96%   resident C + verified asm + overlay C
...
```
decompiled              315060 / 950232  (33.16%)
handwritten asm          17104 / 950232  ( 1.80%)
GLOBAL_ASM remaining    618020 / 950232  (65.04%)
NON_MATCHING                48 / 950232  ( 0.01%)
NON_EQUIVALENT               0 / 950232  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 299 | 172 | 100 | 27 | `████████████▓▓▓▓▓▓░░` 91.0% |
| game code, TU identified | 114 | 7 | 73 | 34 | `█▓▓▓▓▓▓▓▓▓▓▓▓▓░░░░░░` 70.2% |
| game code, not yet split | 1048 | 0 | 57 | 991 | `▓░░░░░░░░░░░░░░░░░░░` 5.4% |
| **total** | 1461 | 179 | 230 | 1052 | `██▓▓▓▓░░░░░░░░░░░░░░` 28.0% |
