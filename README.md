...
[![functions](https://img.shields.io/badge/functions_matched-1000_of_1464_(68.31%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-348084_of_947796_(36.73%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1272_adopted-blue)](#progress)

```
functions     1000 / 1464    68.31%   matched to C, byte-identical
.text bytes 221896 / 478532  46.37%   matched C in the resident segment
...
whole resolved 348084 / 947796  36.73%   resident C + verified asm + overlay C
named         1127 / 1464    76.98%   functions carrying an adopted name
...
```
decompiled              331472 / 947796  (34.97%)
handwritten asm          16612 / 947796  ( 1.75%)
GLOBAL_ASM remaining    285424 / 947796  (30.11%)
...
| game code, TU identified | 991 | 748 | 84 | 159 | `███████████████▓▓░░░` 84.0% |
| game code, not yet split | 184 | 0 | 9 | 175 | `▓░░░░░░░░░░░░░░░░░░░` 4.9% |
| **total** | 1464 | 1000 | 127 | 337 | `██████████████▓░░░░░` 77.0% |
