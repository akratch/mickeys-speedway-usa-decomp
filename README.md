...
[![functions](https://img.shields.io/badge/functions_matched-667_of_1459_(45.72%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-206496_of_947932_(21.78%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1030_adopted-blue)](#progress)

```
functions      667 / 1459    45.72%   matched to C, byte-identical
.text bytes 117880 / 478668  24.63%   matched C in the resident segment
...
whole resolved 206496 / 947932  21.78%   resident C + verified asm + overlay C
...
```
decompiled              189392 / 947932  (19.98%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    519572 / 947932  (54.81%)
