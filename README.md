...
[![functions](https://img.shields.io/badge/functions_matched-924_of_1464_(63.11%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-294720_of_947856_(31.09%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1192_adopted-blue)](#progress)

```
functions      924 / 1464    63.11%   matched to C, byte-identical
.text bytes 182536 / 478592  38.14%   matched C in the resident segment
...
whole resolved 294720 / 947856  31.09%   resident C + verified asm + overlay C
...
```
decompiled              277616 / 947856  (29.29%)
handwritten asm          17104 / 947856  ( 1.80%)
GLOBAL_ASM remaining    324352 / 947856  (34.22%)
