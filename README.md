...
[![functions](https://img.shields.io/badge/functions_matched-158_of_1468_(10.76%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-321736_of_950352_(33.85%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-512_adopted-blue)](#progress)

```
functions      158 / 1468    10.76%   matched to C, byte-identical
.text bytes  28080 / 481088   5.84%   matched C in the resident segment
...
whole resolved 321736 / 950352  33.85%   resident C + verified asm + overlay C
named          439 / 1468    29.90%   functions carrying an adopted name
symbols        512                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              304632 / 950352  (32.05%)
handwritten asm          17104 / 950352  ( 1.80%)
GLOBAL_ASM remaining    628568 / 950352  (66.14%)
...
| game code, TU identified | 188 | 41 | 76 | 71 | `████▓▓▓▓▓▓▓▓░░░░░░░░` 62.2% |
| game code, not yet split | 974 | 0 | 51 | 923 | `▓░░░░░░░░░░░░░░░░░░░` 5.2% |
| **total** | 1468 | 158 | 281 | 1029 | `██▓▓▓▓░░░░░░░░░░░░░░` 29.9% |
