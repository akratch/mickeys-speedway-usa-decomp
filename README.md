...
[![functions](https://img.shields.io/badge/functions_matched-950_of_1464_(64.89%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-312496_of_947844_(32.97%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1199_adopted-blue)](#progress)

```
functions      950 / 1464    64.89%   matched to C, byte-identical
.text bytes 192072 / 478580  40.13%   matched C in the resident segment
...
whole resolved 312496 / 947844  32.97%   resident C + verified asm + overlay C
...
```
decompiled              295392 / 947844  (31.16%)
handwritten asm          17104 / 947844  ( 1.80%)
GLOBAL_ASM remaining    314804 / 947844  (33.21%)
