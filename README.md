...
[![functions](https://img.shields.io/badge/functions_matched-941_of_1464_(64.28%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-302580_of_947848_(31.92%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1195_adopted-blue)](#progress)

```
functions      941 / 1464    64.28%   matched to C, byte-identical
.text bytes 187844 / 478584  39.25%   matched C in the resident segment
...
whole resolved 302580 / 947848  31.92%   resident C + verified asm + overlay C
...
```
decompiled              285476 / 947848  (30.12%)
handwritten asm          17104 / 947848  ( 1.80%)
GLOBAL_ASM remaining    319036 / 947848  (33.66%)
