...
[![functions](https://img.shields.io/badge/functions_matched-952_of_1464_(65.03%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-314192_of_947844_(33.15%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1203_adopted-blue)](#progress)

```
functions      952 / 1464    65.03%   matched to C, byte-identical
.text bytes 193768 / 478580  40.49%   matched C in the resident segment
...
whole resolved 314192 / 947844  33.15%   resident C + verified asm + overlay C
named         1101 / 1464    75.20%   functions carrying an adopted name
symbols       1203                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              297088 / 947844  (31.34%)
handwritten asm          17104 / 947844  ( 1.80%)
GLOBAL_ASM remaining    313108 / 947844  (33.03%)
...
| game code, TU identified | 991 | 706 | 100 | 185 | `██████████████▓▓░░░░` 81.3% |
| game code, not yet split | 184 | 0 | 9 | 175 | `▓░░░░░░░░░░░░░░░░░░░` 4.9% |
| **total** | 1464 | 952 | 149 | 363 | `█████████████▓▓░░░░░` 75.2% |
