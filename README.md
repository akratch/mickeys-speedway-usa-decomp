...
[![functions](https://img.shields.io/badge/functions_matched-157_of_1468_(10.69%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-321688_of_950352_(33.85%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-511_adopted-blue)](#progress)

```
functions      157 / 1468    10.69%   matched to C, byte-identical
.text bytes  28032 / 481088   5.83%   matched C in the resident segment
...
whole resolved 321688 / 950352  33.85%   resident C + verified asm + overlay C
named          438 / 1468    29.84%   functions carrying an adopted name
symbols        511                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              304584 / 950352  (32.05%)
handwritten asm          17104 / 950352  ( 1.80%)
GLOBAL_ASM remaining    628616 / 950352  (66.15%)
...
| game code, TU identified | 188 | 40 | 76 | 72 | `████▓▓▓▓▓▓▓▓░░░░░░░░` 61.7% |
| game code, not yet split | 974 | 0 | 51 | 923 | `▓░░░░░░░░░░░░░░░░░░░` 5.2% |
| **total** | 1468 | 157 | 281 | 1030 | `██▓▓▓▓░░░░░░░░░░░░░░` 29.8% |
