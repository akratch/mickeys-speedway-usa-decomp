...
[![functions](https://img.shields.io/badge/functions_matched-128_of_1468_(8.72%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319956_of_950352_(33.67%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-484_adopted-blue)](#progress)

```
functions      128 / 1468     8.72%   matched to C, byte-identical
.text bytes  26300 / 481088   5.47%   matched C in the resident segment
...
whole resolved 319956 / 950352  33.67%   resident C + verified asm + overlay C
...
```
decompiled              302852 / 950352  (31.87%)
handwritten asm          17104 / 950352  ( 1.80%)
GLOBAL_ASM remaining    630348 / 950352  (66.33%)
...
| game code, TU identified | 169 | 11 | 74 | 84 | `█▓▓▓▓▓▓▓▓▓░░░░░░░░░░` 50.3% |
