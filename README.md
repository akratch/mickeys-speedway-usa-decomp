...
[![functions](https://img.shields.io/badge/functions_matched-199_of_1455_(13.68%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-347904_of_948536_(36.68%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-488_adopted-blue)](#progress)

```
functions      199 / 1455    13.68%   matched to C, byte-identical
.text bytes  54248 / 479272  11.32%   matched C in the resident segment
verified asm  17104 / 479272   3.57%   original hand-written assembly (83 functions)
overlay C   276552 / 469264  58.93%   matched C keyed by overlay and offset
whole resolved 347904 / 948536  36.68%   resident C + verified asm + overlay C
named          416 / 1455    28.59%   functions carrying an adopted name
...
```
decompiled              330800 / 948536  (34.87%)
handwritten asm          17104 / 948536  ( 1.80%)
GLOBAL_ASM remaining    600584 / 948536  (63.32%)
NON_MATCHING                48 / 948536  ( 0.01%)
NON_EQUIVALENT               0 / 948536  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 293 | 192 | 87 | 14 | `█████████████▓▓▓▓▓▓░` 95.2% |
| game code, TU identified | 114 | 7 | 73 | 34 | `█▓▓▓▓▓▓▓▓▓▓▓▓▓░░░░░░` 70.2% |
| game code, not yet split | 1048 | 0 | 57 | 991 | `▓░░░░░░░░░░░░░░░░░░░` 5.4% |
| **total** | 1455 | 199 | 217 | 1039 | `███▓▓▓░░░░░░░░░░░░░░` 28.6% |
