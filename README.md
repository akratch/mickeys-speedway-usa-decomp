...
[![functions](https://img.shields.io/badge/functions_matched-950_of_1464_(64.89%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-313180_of_947848_(33.04%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1199_adopted-blue)](#progress)

```
functions      950 / 1464    64.89%   matched to C, byte-identical
.text bytes 193048 / 478584  40.34%   matched C in the resident segment
verified asm  17104 / 478584   3.57%   original hand-written assembly (83 functions)
overlay C   103028 / 469264  21.96%   matched C keyed by overlay and offset
whole resolved 313180 / 947848  33.04%   resident C + verified asm + overlay C
...
```
decompiled              296076 / 947848  (31.24%)
handwritten asm          17104 / 947848  ( 1.80%)
GLOBAL_ASM remaining    313832 / 947848  (33.11%)
NON_MATCHING            320836 / 947848  (33.85%)
...
| game code, TU identified | 991 | 704 | 102 | 185 | `██████████████▓▓░░░░` 81.3% |
| game code, not yet split | 184 | 0 | 9 | 175 | `▓░░░░░░░░░░░░░░░░░░░` 4.9% |
| **total** | 1464 | 950 | 151 | 363 | `█████████████▓▓░░░░░` 75.2% |
