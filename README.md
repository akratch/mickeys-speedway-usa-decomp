...
[![functions](https://img.shields.io/badge/functions_matched-665_of_1459_(45.58%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-206424_of_947932_(21.78%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1028_adopted-blue)](#progress)

```
functions      665 / 1459    45.58%   matched to C, byte-identical
.text bytes 117808 / 478668  24.61%   matched C in the resident segment
...
whole resolved 206424 / 947932  21.78%   resident C + verified asm + overlay C
named          887 / 1459    60.80%   functions carrying an adopted name
symbols       1028                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              189320 / 947932  (19.97%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    519644 / 947932  (54.82%)
