...
[![functions](https://img.shields.io/badge/functions_matched-860_of_1464_(58.74%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-279032_of_947860_(29.44%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1129_adopted-blue)](#progress)

```
functions      860 / 1464    58.74%   matched to C, byte-identical
.text bytes 167016 / 478596  34.90%   matched C in the resident segment
verified asm  17104 / 478596   3.57%   original hand-written assembly (83 functions)
overlay C    94912 / 469264  20.23%   matched C keyed by overlay and offset
whole resolved 279032 / 947860  29.44%   resident C + verified asm + overlay C
...
```
decompiled              261928 / 947860  (27.63%)
handwritten asm          17104 / 947860  ( 1.80%)
GLOBAL_ASM remaining    344048 / 947860  (36.30%)
NON_MATCHING            324780 / 947860  (34.26%)
NON_EQUIVALENT               0 / 947860  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 289 | 246 | 40 | 3 | `█████████████████▓▓▓` 99.0% |
| game code, TU identified | 991 | 614 | 116 | 261 | `████████████▓▓▓░░░░░` 73.7% |
| game code, not yet split | 184 | 0 | 9 | 175 | `▓░░░░░░░░░░░░░░░░░░░` 4.9% |
| **total** | 1464 | 860 | 165 | 439 | `████████████▓▓░░░░░░` 70.0% |
