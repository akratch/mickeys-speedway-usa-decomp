...
[![functions](https://img.shields.io/badge/functions_matched-128_of_1468_(8.72%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319672_of_950348_(33.64%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-485_adopted-blue)](#progress)

```
functions      128 / 1468     8.72%   matched to C, byte-identical
.text bytes  26016 / 481084   5.41%   matched C in the resident segment
...
whole resolved 319672 / 950348  33.64%   resident C + verified asm + overlay C
...
```
decompiled              302568 / 950348  (31.84%)
handwritten asm          17104 / 950348  ( 1.80%)
GLOBAL_ASM remaining    630628 / 950348  (66.36%)
...
| game code, TU identified | 146 | 11 | 75 | 60 | `██▓▓▓▓▓▓▓▓▓▓░░░░░░░░` 58.9% |
