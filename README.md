...
[![functions](https://img.shields.io/badge/functions_matched-162_of_1468_(11.04%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-321992_of_950352_(33.88%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-516_adopted-blue)](#progress)

```
functions      162 / 1468    11.04%   matched to C, byte-identical
.text bytes  28336 / 481088   5.89%   matched C in the resident segment
...
whole resolved 321992 / 950352  33.88%   resident C + verified asm + overlay C
named          443 / 1468    30.18%   functions carrying an adopted name
symbols        516                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              304888 / 950352  (32.08%)
handwritten asm          17104 / 950352  ( 1.80%)
GLOBAL_ASM remaining    628312 / 950352  (66.11%)
...
| game code, TU identified | 188 | 45 | 76 | 67 | `█████▓▓▓▓▓▓▓▓░░░░░░░` 64.4% |
| game code, not yet split | 974 | 0 | 51 | 923 | `▓░░░░░░░░░░░░░░░░░░░` 5.2% |
| **total** | 1468 | 162 | 281 | 1025 | `██▓▓▓▓░░░░░░░░░░░░░░` 30.2% |
