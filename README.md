...
[![functions](https://img.shields.io/badge/functions_matched-932_of_1464_(63.66%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-296464_of_947848_(31.28%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1190_adopted-blue)](#progress)

```
functions      932 / 1464    63.66%   matched to C, byte-identical
.text bytes 183140 / 478584  38.27%   matched C in the resident segment
verified asm  17104 / 478584   3.57%   original hand-written assembly (83 functions)
overlay C    96220 / 469264  20.50%   matched C keyed by overlay and offset
whole resolved 296464 / 947848  31.28%   resident C + verified asm + overlay C
named         1089 / 1464    74.39%   functions carrying an adopted name
...
```
decompiled              279360 / 947848  (29.47%)
handwritten asm          17104 / 947848  ( 1.80%)
GLOBAL_ASM remaining    323740 / 947848  (34.16%)
NON_MATCHING            327644 / 947848  (34.57%)
...
| game code, TU identified | 991 | 686 | 108 | 197 | `██████████████▓▓░░░░` 80.1% |
| game code, not yet split | 184 | 0 | 9 | 175 | `▓░░░░░░░░░░░░░░░░░░░` 4.9% |
| **total** | 1464 | 932 | 157 | 375 | `█████████████▓▓░░░░░` 74.4% |
