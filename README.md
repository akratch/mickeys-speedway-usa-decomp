...
[![functions](https://img.shields.io/badge/functions_matched-127_of_1468_(8.65%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319624_of_950364_(33.63%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-484_adopted-blue)](#progress)

```
functions      127 / 1468     8.65%   matched to C, byte-identical
.text bytes  25968 / 481100   5.40%   matched C in the resident segment
...
whole resolved 319624 / 950364  33.63%   resident C + verified asm + overlay C
...
```
decompiled              302520 / 950364  (31.83%)
handwritten asm          17104 / 950364  ( 1.80%)
GLOBAL_ASM remaining    630692 / 950364  (66.36%)
...
| game code, TU identified | 188 | 10 | 79 | 99 | `█▓▓▓▓▓▓▓▓░░░░░░░░░░░` 47.3% |
