...
[![functions](https://img.shields.io/badge/functions_matched-666_of_1459_(45.65%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-207948_of_947932_(21.94%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1025_adopted-blue)](#progress)

```
functions      666 / 1459    45.65%   matched to C, byte-identical
.text bytes 118356 / 478668  24.73%   matched C in the resident segment
...
whole resolved 207948 / 947932  21.94%   resident C + verified asm + overlay C
...
```
decompiled              190844 / 947932  (20.13%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    519096 / 947932  (54.76%)
