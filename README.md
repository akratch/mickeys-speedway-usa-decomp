...
[![functions](https://img.shields.io/badge/functions_matched-667_of_1459_(45.72%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-208348_of_947932_(21.98%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1029_adopted-blue)](#progress)

```
functions      667 / 1459    45.72%   matched to C, byte-identical
.text bytes 119124 / 478668  24.89%   matched C in the resident segment
...
whole resolved 208348 / 947932  21.98%   resident C + verified asm + overlay C
...
```
decompiled              191244 / 947932  (20.17%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    518328 / 947932  (54.68%)
