...
[![functions](https://img.shields.io/badge/functions_matched-155_of_1468_(10.56%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-321604_of_950352_(33.84%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-509_adopted-blue)](#progress)

```
functions      155 / 1468    10.56%   matched to C, byte-identical
.text bytes  27948 / 481088   5.81%   matched C in the resident segment
...
whole resolved 321604 / 950352  33.84%   resident C + verified asm + overlay C
named          436 / 1468    29.70%   functions carrying an adopted name
symbols        509                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              304500 / 950352  (32.04%)
handwritten asm          17104 / 950352  ( 1.80%)
GLOBAL_ASM remaining    628700 / 950352  (66.15%)
...
| game code, TU identified | 188 | 38 | 76 | 74 | `████▓▓▓▓▓▓▓▓░░░░░░░░` 60.6% |
| game code, not yet split | 974 | 0 | 51 | 923 | `▓░░░░░░░░░░░░░░░░░░░` 5.2% |
| **total** | 1468 | 155 | 281 | 1032 | `██▓▓▓▓░░░░░░░░░░░░░░` 29.7% |
