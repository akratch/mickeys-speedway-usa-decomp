...
[![functions](https://img.shields.io/badge/functions_matched-710_of_1460_(48.63%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-230284_of_947920_(24.29%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1063_adopted-blue)](#progress)
...
whole resolved 230284 / 947920  24.29%   resident C + verified asm + overlay C
named          920 / 1460    63.01%   functions carrying an adopted name
symbols       1063                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              213180 / 947920  (22.49%)
handwritten asm          17104 / 947920  ( 1.80%)
GLOBAL_ASM remaining    503480 / 947920  (53.11%)
NON_MATCHING            214156 / 947920  (22.59%)
