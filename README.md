...
[![functions](https://img.shields.io/badge/functions_matched-669_of_1459_(45.85%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-217776_of_947932_(22.97%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1030_adopted-blue)](#progress)

```
functions      669 / 1459    45.85%   matched to C, byte-identical
.text bytes 118700 / 478668  24.80%   matched C in the resident segment
...
whole resolved 217776 / 947932  22.97%   resident C + verified asm + overlay C
...
```
decompiled              200672 / 947932  (21.17%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    518752 / 947932  (54.72%)
