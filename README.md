...
[![functions](https://img.shields.io/badge/functions_matched-675_of_1459_(46.26%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-219132_of_947932_(23.12%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1036_adopted-blue)](#progress)

```
functions      675 / 1459    46.26%   matched to C, byte-identical
.text bytes 120056 / 478668  25.08%   matched C in the resident segment
...
whole resolved 219132 / 947932  23.12%   resident C + verified asm + overlay C
...
```
decompiled              202028 / 947932  (21.31%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    517396 / 947932  (54.58%)
