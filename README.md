...
[![functions](https://img.shields.io/badge/functions_matched-126_of_1468_(8.58%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319616_of_950360_(33.63%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-483_adopted-blue)](#progress)

```
functions      126 / 1468     8.58%   matched to C, byte-identical
.text bytes  25960 / 481096   5.40%   matched C in the resident segment
...
whole resolved 319616 / 950360  33.63%   resident C + verified asm + overlay C
...
```
decompiled              302512 / 950360  (31.83%)
handwritten asm          17104 / 950360  ( 1.80%)
GLOBAL_ASM remaining    630696 / 950360  (66.36%)
...
| game code, TU identified | 133 | 9 | 73 | 51 | `█▓▓▓▓▓▓▓▓▓▓▓░░░░░░░░` 61.7% |
