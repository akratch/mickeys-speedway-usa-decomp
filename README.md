...
[![functions](https://img.shields.io/badge/functions_matched-128_of_1468_(8.72%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319872_of_950348_(33.66%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-481_adopted-blue)](#progress)

```
functions      128 / 1468     8.72%   matched to C, byte-identical
.text bytes  26216 / 481084   5.45%   matched C in the resident segment
...
whole resolved 319872 / 950348  33.66%   resident C + verified asm + overlay C
...
```
decompiled              302768 / 950348  (31.86%)
handwritten asm          17104 / 950348  ( 1.80%)
GLOBAL_ASM remaining    630428 / 950348  (66.34%)
...
| game code, TU identified | 137 | 11 | 73 | 53 | `██▓▓▓▓▓▓▓▓▓▓░░░░░░░░` 61.3% |
