...
[![functions](https://img.shields.io/badge/functions_matched-160_of_1461_(10.95%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-323620_of_950264_(34.06%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-483_adopted-blue)](#progress)

```
functions      160 / 1461    10.95%   matched to C, byte-identical
.text bytes  29964 / 481000   6.23%   matched C in the resident segment
verified asm  17104 / 481000   3.56%   original hand-written assembly (83 functions)
overlay C   276552 / 469264  58.93%   matched C keyed by overlay and offset
whole resolved 323620 / 950264  34.06%   resident C + verified asm + overlay C
...
```
decompiled              306516 / 950264  (32.26%)
handwritten asm          17104 / 950264  ( 1.80%)
GLOBAL_ASM remaining    626596 / 950264  (65.94%)
NON_MATCHING                48 / 950264  ( 0.01%)
NON_EQUIVALENT               0 / 950264  ( 0.00%)
```
