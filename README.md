...
[![functions](https://img.shields.io/badge/functions_matched-127_of_1468_(8.65%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319704_of_950348_(33.64%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-484_adopted-blue)](#progress)

```
functions      127 / 1468     8.65%   matched to C, byte-identical
.text bytes  26048 / 481084   5.41%   matched C in the resident segment
...
whole resolved 319704 / 950348  33.64%   resident C + verified asm + overlay C
...
```
decompiled              302600 / 950348  (31.84%)
handwritten asm          17104 / 950348  ( 1.80%)
GLOBAL_ASM remaining    630596 / 950348  (66.35%)
...
| game code, TU identified | 148 | 10 | 74 | 64 | `█▓▓▓▓▓▓▓▓▓▓░░░░░░░░░` 56.8% |
