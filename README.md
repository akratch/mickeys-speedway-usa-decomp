...
[![functions](https://img.shields.io/badge/functions_matched-851_of_1464_(58.13%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-267136_of_947876_(28.18%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1128_adopted-blue)](#progress)

```
functions      851 / 1464    58.13%   matched to C, byte-identical
.text bytes 161976 / 478612  33.84%   matched C in the resident segment
...
whole resolved 267136 / 947876  28.18%   resident C + verified asm + overlay C
named         1021 / 1464    69.74%   functions carrying an adopted name
...
```
decompiled              250032 / 947876  (26.38%)
handwritten asm          17104 / 947876  ( 1.80%)
GLOBAL_ASM remaining    395084 / 947876  (41.68%)
...
| game code, TU identified | 991 | 605 | 121 | 265 | `████████████▓▓▓░░░░░` 73.3% |
| game code, not yet split | 184 | 0 | 9 | 175 | `▓░░░░░░░░░░░░░░░░░░░` 4.9% |
| **total** | 1464 | 851 | 170 | 443 | `████████████▓▓░░░░░░` 69.7% |
