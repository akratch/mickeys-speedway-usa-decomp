...
[![functions](https://img.shields.io/badge/functions_matched-163_of_1461_(11.16%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-323956_of_950264_(34.09%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-483_adopted-blue)](#progress)

```
functions      163 / 1461    11.16%   matched to C, byte-identical
.text bytes  30300 / 481000   6.30%   matched C in the resident segment
...
whole resolved 323956 / 950264  34.09%   resident C + verified asm + overlay C
...
```
decompiled              306852 / 950264  (32.29%)
handwritten asm          17104 / 950264  ( 1.80%)
GLOBAL_ASM remaining    626260 / 950264  (65.90%)
