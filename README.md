...
[![functions](https://img.shields.io/badge/functions_matched-941_of_1464_(64.28%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-302680_of_947848_(31.93%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1195_adopted-blue)](#progress)

```
functions      941 / 1464    64.28%   matched to C, byte-identical
.text bytes 187944 / 478584  39.27%   matched C in the resident segment
verified asm  17104 / 478584   3.57%   original hand-written assembly (83 functions)
overlay C    97632 / 469264  20.81%   matched C keyed by overlay and offset
whole resolved 302680 / 947848  31.93%   resident C + verified asm + overlay C
...
```
decompiled              285576 / 947848  (30.13%)
handwritten asm          17104 / 947848  ( 1.80%)
GLOBAL_ASM remaining    318936 / 947848  (33.65%)
NON_MATCHING            326232 / 947848  (34.42%)
