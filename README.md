...
[![functions](https://img.shields.io/badge/functions_matched-131_of_1468_(8.92%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319920_of_950348_(33.66%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-484_adopted-blue)](#progress)

```
functions      131 / 1468     8.92%   matched to C, byte-identical
.text bytes  26264 / 481084   5.46%   matched C in the resident segment
...
whole resolved 319920 / 950348  33.66%   resident C + verified asm + overlay C
...
```
decompiled              302816 / 950348  (31.86%)
handwritten asm          17104 / 950348  ( 1.80%)
GLOBAL_ASM remaining    630380 / 950348  (66.33%)
...
| game code, TU identified | 137 | 14 | 73 | 50 | `██▓▓▓▓▓▓▓▓▓▓▓░░░░░░░` 63.5% |
