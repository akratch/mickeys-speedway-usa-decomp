...
[![functions](https://img.shields.io/badge/functions_matched-129_of_1468_(8.79%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319984_of_950352_(33.67%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-485_adopted-blue)](#progress)

```
functions      129 / 1468     8.79%   matched to C, byte-identical
.text bytes  26328 / 481088   5.47%   matched C in the resident segment
...
whole resolved 319984 / 950352  33.67%   resident C + verified asm + overlay C
...
```
decompiled              302880 / 950352  (31.87%)
handwritten asm          17104 / 950352  ( 1.80%)
GLOBAL_ASM remaining    630320 / 950352  (66.32%)
...
| game code, TU identified | 169 | 12 | 74 | 83 | `█▓▓▓▓▓▓▓▓▓░░░░░░░░░░` 50.9% |
