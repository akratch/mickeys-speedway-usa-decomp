...
[![functions](https://img.shields.io/badge/functions_matched-663_of_1459_(45.44%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-206484_of_947932_(21.78%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1024_adopted-blue)](#progress)

```
functions      663 / 1459    45.44%   matched to C, byte-identical
.text bytes 117868 / 478668  24.62%   matched C in the resident segment
...
whole resolved 206484 / 947932  21.78%   resident C + verified asm + overlay C
...
```
decompiled              189380 / 947932  (19.98%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    519584 / 947932  (54.81%)
