...
[![functions](https://img.shields.io/badge/functions_matched-154_of_1468_(10.49%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-321592_of_950352_(33.84%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-508_adopted-blue)](#progress)

```
functions      154 / 1468    10.49%   matched to C, byte-identical
.text bytes  27936 / 481088   5.81%   matched C in the resident segment
...
whole resolved 321592 / 950352  33.84%   resident C + verified asm + overlay C
named          435 / 1468    29.63%   functions carrying an adopted name
symbols        508                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              304488 / 950352  (32.04%)
handwritten asm          17104 / 950352  ( 1.80%)
GLOBAL_ASM remaining    628712 / 950352  (66.16%)
...
| game code, TU identified | 188 | 37 | 76 | 75 | `████▓▓▓▓▓▓▓▓░░░░░░░░` 60.1% |
| game code, not yet split | 974 | 0 | 51 | 923 | `▓░░░░░░░░░░░░░░░░░░░` 5.2% |
| **total** | 1468 | 154 | 281 | 1033 | `██▓▓▓▓░░░░░░░░░░░░░░` 29.6% |
