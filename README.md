...
[![functions](https://img.shields.io/badge/functions_matched-129_of_1468_(8.79%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319876_of_950348_(33.66%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-486_adopted-blue)](#progress)

```
functions      129 / 1468     8.79%   matched to C, byte-identical
.text bytes  26220 / 481084   5.45%   matched C in the resident segment
...
whole resolved 319876 / 950348  33.66%   resident C + verified asm + overlay C
...
```
decompiled              302772 / 950348  (31.86%)
handwritten asm          17104 / 950348  ( 1.80%)
GLOBAL_ASM remaining    630424 / 950348  (66.34%)
...
| game code, TU identified | 148 | 12 | 74 | 62 | `██▓▓▓▓▓▓▓▓▓▓░░░░░░░░` 58.1% |
