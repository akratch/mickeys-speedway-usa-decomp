...
[![functions](https://img.shields.io/badge/functions_matched-952_of_1464_(65.03%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-312968_of_947844_(33.02%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1200_adopted-blue)](#progress)

```
functions      952 / 1464    65.03%   matched to C, byte-identical
.text bytes 192544 / 478580  40.23%   matched C in the resident segment
...
whole resolved 312968 / 947844  33.02%   resident C + verified asm + overlay C
...
```
decompiled              295864 / 947844  (31.21%)
handwritten asm          17104 / 947844  ( 1.80%)
GLOBAL_ASM remaining    314332 / 947844  (33.16%)
