...
[![functions](https://img.shields.io/badge/functions_matched-127_of_1468_(8.65%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319656_of_950348_(33.64%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-484_adopted-blue)](#progress)

```
functions      127 / 1468     8.65%   matched to C, byte-identical
.text bytes  26000 / 481084   5.40%   matched C in the resident segment
...
whole resolved 319656 / 950348  33.64%   resident C + verified asm + overlay C
...
```
decompiled              302552 / 950348  (31.84%)
handwritten asm          17104 / 950348  ( 1.80%)
GLOBAL_ASM remaining    630644 / 950348  (66.36%)
...
| game code, TU identified | 146 | 10 | 75 | 61 | `█▓▓▓▓▓▓▓▓▓▓▓░░░░░░░░` 58.2% |
