...
[![functions](https://img.shields.io/badge/functions_matched-295_of_1459_(20.22%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-157708_of_948560_(16.63%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-550_adopted-blue)](#progress)

```
functions      295 / 1459    20.22%   matched to C, byte-identical
.text bytes  60752 / 479296  12.68%   matched C in the resident segment
verified asm  17104 / 479296   3.57%   original hand-written assembly (83 functions)
overlay C    79852 / 469264  17.02%   matched C keyed by overlay and offset
whole resolved 157708 / 948560  16.63%   resident C + verified asm + overlay C
named          498 / 1459    34.13%   functions carrying an adopted name
symbols        550                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              140604 / 948560  (14.82%)
handwritten asm          17104 / 948560  ( 1.80%)
GLOBAL_ASM remaining    589852 / 948560  (62.18%)
NON_MATCHING            201000 / 948560  (21.19%)
NON_EQUIVALENT               0 / 948560  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 293 | 194 | 85 | 14 | `█████████████▓▓▓▓▓▓░` 95.2% |
| game code, TU identified | 421 | 101 | 80 | 240 | `█████▓▓▓▓░░░░░░░░░░░` 43.0% |
| game code, not yet split | 745 | 0 | 38 | 707 | `▓░░░░░░░░░░░░░░░░░░░` 5.1% |
| **total** | 1459 | 295 | 203 | 961 | `████▓▓▓░░░░░░░░░░░░░` 34.1% |
