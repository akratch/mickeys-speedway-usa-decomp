...
[![functions](https://img.shields.io/badge/functions_matched-472_of_1459_(32.35%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-194612_of_947928_(20.53%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-989_adopted-blue)](#progress)

```
functions      472 / 1459    32.35%   matched to C, byte-identical
.text bytes  97052 / 478664  20.28%   matched C in the resident segment
...
whole resolved 194612 / 947928  20.53%   resident C + verified asm + overlay C
named          730 / 1459    50.03%   functions carrying an adopted name
symbols        989                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              177508 / 947928  (18.73%)
handwritten asm          17104 / 947928  ( 1.80%)
GLOBAL_ASM remaining    552920 / 947928  (58.33%)
...
| game code, TU identified | 912 | 226 | 203 | 483 | `█████▓▓▓▓░░░░░░░░░░░` 47.0% |
| game code, not yet split | 258 | 0 | 15 | 243 | `▓░░░░░░░░░░░░░░░░░░░` 5.8% |
| **total** | 1459 | 472 | 258 | 729 | `██████▓▓▓▓░░░░░░░░░░` 50.0% |
