...
[![functions](https://img.shields.io/badge/functions_matched-993_of_1464_(67.83%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-345428_of_947804_(36.45%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1272_adopted-blue)](#progress)

```
functions      993 / 1464    67.83%   matched to C, byte-identical
.text bytes 219472 / 478540  45.86%   matched C in the resident segment
...
whole resolved 345428 / 947804  36.45%   resident C + verified asm + overlay C
...
```
decompiled              328816 / 947804  (34.69%)
handwritten asm          16612 / 947804  ( 1.75%)
GLOBAL_ASM remaining    287856 / 947804  (30.37%)
