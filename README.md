...
[![functions](https://img.shields.io/badge/functions_matched-196_of_1460_(13.42%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-339324_of_950224_(35.71%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-490_adopted-blue)](#progress)

```
functions      196 / 1460    13.42%   matched to C, byte-identical
.text bytes  45668 / 480960   9.50%   matched C in the resident segment
verified asm  17104 / 480960   3.56%   original hand-written assembly (83 functions)
overlay C   276552 / 469264  58.93%   matched C keyed by overlay and offset
whole resolved 339324 / 950224  35.71%   resident C + verified asm + overlay C
named          412 / 1460    28.22%   functions carrying an adopted name
...
```
decompiled              322220 / 950224  (33.91%)
handwritten asm          17104 / 950224  ( 1.80%)
GLOBAL_ASM remaining    610852 / 950224  (64.29%)
NON_MATCHING                48 / 950224  ( 0.01%)
NON_EQUIVALENT               0 / 950224  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 298 | 189 | 86 | 23 | `█████████████▓▓▓▓▓░░` 92.3% |
| game code, TU identified | 114 | 7 | 73 | 34 | `█▓▓▓▓▓▓▓▓▓▓▓▓▓░░░░░░` 70.2% |
| game code, not yet split | 1048 | 0 | 57 | 991 | `▓░░░░░░░░░░░░░░░░░░░` 5.4% |
| **total** | 1460 | 196 | 216 | 1048 | `███▓▓▓░░░░░░░░░░░░░░` 28.2% |
