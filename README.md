...
[![functions](https://img.shields.io/badge/functions_matched-989_of_1464_(67.55%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-343020_of_947832_(36.19%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1272_adopted-blue)](#progress)

```
functions      989 / 1464    67.55%   matched to C, byte-identical
.text bytes 217548 / 478568  45.46%   matched C in the resident segment
...
whole resolved 343020 / 947832  36.19%   resident C + verified asm + overlay C
...
```
decompiled              326408 / 947832  (34.44%)
handwritten asm          16612 / 947832  ( 1.75%)
GLOBAL_ASM remaining    289808 / 947832  (30.58%)
