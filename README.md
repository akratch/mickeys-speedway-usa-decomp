...
[![functions](https://img.shields.io/badge/functions_matched-815_of_1460_(55.82%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-260288_of_947896_(27.46%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1107_adopted-blue)](#progress)

```
functions      815 / 1460    55.82%   matched to C, byte-identical
.text bytes 154992 / 478632  32.38%   matched C in the resident segment
verified asm  17104 / 478632   3.57%   original hand-written assembly (83 functions)
overlay C    88192 / 469264  18.79%   matched C keyed by overlay and offset
whole resolved 260288 / 947896  27.46%   resident C + verified asm + overlay C
named          994 / 1460    68.08%   functions carrying an adopted name
symbols       1107                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              243184 / 947896  (25.66%)
handwritten asm          17104 / 947896  ( 1.80%)
GLOBAL_ASM remaining    408844 / 947896  (43.13%)
NON_MATCHING            278764 / 947896  (29.41%)
...
| game code, TU identified | 987 | 569 | 130 | 288 | `████████████▓▓░░░░░░` 70.8% |
| game code, not yet split | 184 | 0 | 9 | 175 | `▓░░░░░░░░░░░░░░░░░░░` 4.9% |
| **total** | 1460 | 815 | 179 | 466 | `███████████▓▓▓░░░░░░` 68.1% |
