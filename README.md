...
[![functions](https://img.shields.io/badge/functions_matched-299_of_1457_(20.52%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-162560_of_947968_(17.15%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-604_adopted-blue)](#progress)

```
functions      299 / 1457    20.52%   matched to C, byte-identical
.text bytes  65000 / 478704  13.58%   matched C in the resident segment
verified asm  17104 / 478704   3.57%   original hand-written assembly (83 functions)
overlay C    80456 / 469264  17.15%   matched C keyed by overlay and offset
whole resolved 162560 / 947968  17.15%   resident C + verified asm + overlay C
named          517 / 1457    35.48%   functions carrying an adopted name
symbols        604                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              145456 / 947968  (15.34%)
handwritten asm          17104 / 947968  ( 1.80%)
GLOBAL_ASM remaining    585012 / 947968  (61.71%)
NON_MATCHING            200396 / 947968  (21.14%)
NON_EQUIVALENT               0 / 947968  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 290 | 204 | 75 | 11 | `██████████████▓▓▓▓▓░` 96.2% |
| game code, TU identified | 491 | 95 | 107 | 289 | `████▓▓▓▓░░░░░░░░░░░░` 41.1% |
| game code, not yet split | 676 | 0 | 36 | 640 | `▓░░░░░░░░░░░░░░░░░░░` 5.3% |
| **total** | 1457 | 299 | 218 | 940 | `████▓▓▓░░░░░░░░░░░░░` 35.5% |
