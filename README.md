...
[![functions](https://img.shields.io/badge/functions_matched-130_of_1468_(8.86%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319944_of_950348_(33.67%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-487_adopted-blue)](#progress)

```
functions      130 / 1468     8.86%   matched to C, byte-identical
.text bytes  26288 / 481084   5.46%   matched C in the resident segment
...
whole resolved 319944 / 950348  33.67%   resident C + verified asm + overlay C
...
```
decompiled              302840 / 950348  (31.87%)
handwritten asm          17104 / 950348  ( 1.80%)
GLOBAL_ASM remaining    630356 / 950348  (66.33%)
...
| game code, TU identified | 148 | 13 | 74 | 61 | `██▓▓▓▓▓▓▓▓▓▓░░░░░░░░` 58.8% |
