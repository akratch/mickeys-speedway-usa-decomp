...
[![functions](https://img.shields.io/badge/functions_matched-707_of_1459_(48.46%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-232452_of_947916_(24.52%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1057_adopted-blue)](#progress)

```
functions      707 / 1459    48.46%   matched to C, byte-identical
.text bytes 132052 / 478652  27.59%   matched C in the resident segment
verified asm  17104 / 478652   3.57%   original hand-written assembly (83 functions)
overlay C    83296 / 469264  17.75%   matched C keyed by overlay and offset
whole resolved 232452 / 947916  24.52%   resident C + verified asm + overlay C
named          921 / 1459    63.13%   functions carrying an adopted name
...
```
decompiled              215348 / 947916  (22.72%)
handwritten asm          17104 / 947916  ( 1.80%)
GLOBAL_ASM remaining    501172 / 947916  (52.87%)
NON_MATCHING            214292 / 947916  (22.61%)
NON_EQUIVALENT               0 / 947916  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 289 | 246 | 40 | 3 | `█████████████████▓▓▓` 99.0% |
| game code, TU identified | 986 | 461 | 165 | 360 | `█████████▓▓▓▓░░░░░░░` 63.5% |
| game code, not yet split | 184 | 0 | 9 | 175 | `▓░░░░░░░░░░░░░░░░░░░` 4.9% |
| **total** | 1459 | 707 | 214 | 538 | `██████████▓▓▓░░░░░░░` 63.1% |
