...
[![functions](https://img.shields.io/badge/functions_matched-129_of_1468_(8.79%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319716_of_950348_(33.64%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-486_adopted-blue)](#progress)

```
functions      129 / 1468     8.79%   matched to C, byte-identical
.text bytes  26060 / 481084   5.42%   matched C in the resident segment
...
whole resolved 319716 / 950348  33.64%   resident C + verified asm + overlay C
...
```
decompiled              302612 / 950348  (31.84%)
handwritten asm          17104 / 950348  ( 1.80%)
GLOBAL_ASM remaining    630584 / 950348  (66.35%)
...
| game code, TU identified | 146 | 12 | 75 | 59 | `██▓▓▓▓▓▓▓▓▓▓░░░░░░░░` 59.6% |
