...
[![functions](https://img.shields.io/badge/functions_matched-995_of_1464_(67.96%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-346236_of_947796_(36.53%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1272_adopted-blue)](#progress)

```
functions      995 / 1464    67.96%   matched to C, byte-identical
.text bytes 220280 / 478532  46.03%   matched C in the resident segment
...
whole resolved 346236 / 947796  36.53%   resident C + verified asm + overlay C
...
```
decompiled              329624 / 947796  (34.78%)
handwritten asm          16612 / 947796  ( 1.75%)
GLOBAL_ASM remaining    287040 / 947796  (30.28%)
