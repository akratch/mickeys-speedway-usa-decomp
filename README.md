...
[![functions](https://img.shields.io/badge/functions_matched-980_of_1464_(66.94%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-335084_of_947832_(35.35%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1237_adopted-blue)](#progress)
...
overlay C   105380 / 469264  22.46%   matched C keyed by overlay and offset
whole resolved 335084 / 947832  35.35%   resident C + verified asm + overlay C
named         1119 / 1464    76.43%   functions carrying an adopted name
symbols       1237                    adopted in symbol_addrs.us.txt
```
