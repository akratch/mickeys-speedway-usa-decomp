...
[![functions](https://img.shields.io/badge/functions_matched-201_of_1460_(13.77%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-343400_of_950220_(36.14%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-492_adopted-blue)](#progress)

```
functions      201 / 1460    13.77%   matched to C, byte-identical
.text bytes  49744 / 480956  10.34%   matched C in the resident segment
...
whole resolved 343400 / 950220  36.14%   resident C + verified asm + overlay C
...
```
decompiled              326296 / 950220  (34.34%)
handwritten asm          17104 / 950220  ( 1.80%)
GLOBAL_ASM remaining    606772 / 950220  (63.86%)
