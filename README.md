...
[![functions](https://img.shields.io/badge/functions_matched-672_of_1459_(46.06%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-219096_of_947932_(23.11%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1033_adopted-blue)](#progress)

```
functions      672 / 1459    46.06%   matched to C, byte-identical
.text bytes 120020 / 478668  25.07%   matched C in the resident segment
...
whole resolved 219096 / 947932  23.11%   resident C + verified asm + overlay C
...
```
decompiled              201992 / 947932  (21.31%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    517432 / 947932  (54.59%)
