...
[![functions](https://img.shields.io/badge/functions_matched-159_of_1468_(10.83%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-321772_of_950352_(33.86%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-513_adopted-blue)](#progress)

```
functions      159 / 1468    10.83%   matched to C, byte-identical
.text bytes  28116 / 481088   5.84%   matched C in the resident segment
...
whole resolved 321772 / 950352  33.86%   resident C + verified asm + overlay C
named          440 / 1468    29.97%   functions carrying an adopted name
symbols        513                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              304668 / 950352  (32.06%)
handwritten asm          17104 / 950352  ( 1.80%)
GLOBAL_ASM remaining    628532 / 950352  (66.14%)
...
| game code, TU identified | 188 | 42 | 76 | 70 | `████▓▓▓▓▓▓▓▓▓░░░░░░░` 62.8% |
| game code, not yet split | 974 | 0 | 51 | 923 | `▓░░░░░░░░░░░░░░░░░░░` 5.2% |
| **total** | 1468 | 159 | 281 | 1028 | `██▓▓▓▓░░░░░░░░░░░░░░` 30.0% |
