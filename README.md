...
[![functions](https://img.shields.io/badge/functions_matched-992_of_1464_(67.76%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-344692_of_947804_(36.37%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1272_adopted-blue)](#progress)

```
functions      992 / 1464    67.76%   matched to C, byte-identical
.text bytes 218736 / 478540  45.71%   matched C in the resident segment
verified asm  16612 / 478540   3.47%   original hand-written assembly (82 functions)
overlay C   109344 / 469264  23.30%   matched C keyed by overlay and offset
whole resolved 344692 / 947804  36.37%   resident C + verified asm + overlay C
...
```
decompiled              328080 / 947804  (34.61%)
handwritten asm          16612 / 947804  ( 1.75%)
GLOBAL_ASM remaining    288592 / 947804  (30.45%)
NON_MATCHING            314520 / 947804  (33.18%)
NON_EQUIVALENT               0 / 947804  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 289 | 249 | 37 | 3 | `█████████████████▓▓▓` 99.0% |
| game code, TU identified | 991 | 743 | 86 | 162 | `███████████████▓▓░░░` 83.7% |
| game code, not yet split | 184 | 0 | 9 | 175 | `▓░░░░░░░░░░░░░░░░░░░` 4.9% |
| **total** | 1464 | 992 | 132 | 340 | `██████████████▓░░░░░` 76.8% |
