...
[![functions](https://img.shields.io/badge/functions_matched-463_of_1459_(31.73%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-193568_of_947928_(20.42%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-978_adopted-blue)](#progress)

```
functions      463 / 1459    31.73%   matched to C, byte-identical
.text bytes  96008 / 478664  20.06%   matched C in the resident segment
...
whole resolved 193568 / 947928  20.42%   resident C + verified asm + overlay C
named          721 / 1459    49.42%   functions carrying an adopted name
symbols        978                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              176464 / 947928  (18.62%)
handwritten asm          17104 / 947928  ( 1.80%)
GLOBAL_ASM remaining    553964 / 947928  (58.44%)
NON_MATCHING            200396 / 947928  (21.14%)
...
| game code, TU identified | 878 | 217 | 202 | 459 | `█████▓▓▓▓▓░░░░░░░░░░` 47.7% |
| game code, not yet split | 292 | 0 | 16 | 276 | `▓░░░░░░░░░░░░░░░░░░░` 5.5% |
| **total** | 1459 | 463 | 258 | 738 | `██████▓▓▓▓░░░░░░░░░░` 49.4% |
