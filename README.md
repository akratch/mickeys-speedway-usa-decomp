...
[![functions](https://img.shields.io/badge/functions_matched-666_of_1459_(45.65%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-208020_of_947932_(21.94%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1028_adopted-blue)](#progress)

```
functions      666 / 1459    45.65%   matched to C, byte-identical
.text bytes 118796 / 478668  24.82%   matched C in the resident segment
...
whole resolved 208020 / 947932  21.94%   resident C + verified asm + overlay C
...
```
decompiled              190916 / 947932  (20.14%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    518656 / 947932  (54.71%)
