...
[![functions](https://img.shields.io/badge/functions_matched-923_of_1464_(63.05%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-294004_of_947856_(31.02%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1191_adopted-blue)](#progress)

```
functions      923 / 1464    63.05%   matched to C, byte-identical
.text bytes 181820 / 478592  37.99%   matched C in the resident segment
...
whole resolved 294004 / 947856  31.02%   resident C + verified asm + overlay C
named         1087 / 1464    74.25%   functions carrying an adopted name
symbols       1191                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              276900 / 947856  (29.21%)
handwritten asm          17104 / 947856  ( 1.80%)
GLOBAL_ASM remaining    325068 / 947856  (34.30%)
NON_MATCHING            328784 / 947856  (34.69%)
...
| game code, TU identified | 991 | 677 | 115 | 199 | `██████████████▓▓░░░░` 79.9% |
| game code, not yet split | 184 | 0 | 9 | 175 | `▓░░░░░░░░░░░░░░░░░░░` 4.9% |
| **total** | 1464 | 923 | 164 | 377 | `█████████████▓▓░░░░░` 74.2% |
