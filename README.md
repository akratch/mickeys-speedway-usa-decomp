...
[![functions](https://img.shields.io/badge/functions_matched-162_of_1461_(11.09%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-323228_of_950296_(34.01%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-551_adopted-blue)](#progress)

```
functions      162 / 1461    11.09%   matched to C, byte-identical
.text bytes  29572 / 481032   6.15%   matched C in the resident segment
verified asm  17104 / 481032   3.56%   original hand-written assembly (83 functions)
overlay C   276552 / 469264  58.93%   matched C keyed by overlay and offset
whole resolved 323228 / 950296  34.01%   resident C + verified asm + overlay C
named          434 / 1461    29.71%   functions carrying an adopted name
symbols        551                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              306124 / 950296  (32.21%)
handwritten asm          17104 / 950296  ( 1.80%)
GLOBAL_ASM remaining    627020 / 950296  (65.98%)
NON_MATCHING                48 / 950296  ( 0.01%)
NON_EQUIVALENT               0 / 950296  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 299 | 151 | 120 | 28 | `██████████▓▓▓▓▓▓▓▓░░` 90.6% |
| game code, TU identified | 189 | 11 | 102 | 76 | `█▓▓▓▓▓▓▓▓▓▓▓░░░░░░░░` 59.8% |
| game code, not yet split | 973 | 0 | 50 | 923 | `▓░░░░░░░░░░░░░░░░░░░` 5.1% |
| **total** | 1461 | 162 | 272 | 1027 | `██▓▓▓▓░░░░░░░░░░░░░░` 29.7% |
