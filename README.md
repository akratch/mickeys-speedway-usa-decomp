...
[![functions](https://img.shields.io/badge/functions_matched-142_of_1468_(9.67%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-320508_of_950352_(33.73%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-496_adopted-blue)](#progress)

```
functions      142 / 1468     9.67%   matched to C, byte-identical
.text bytes  26852 / 481088   5.58%   matched C in the resident segment
...
whole resolved 320508 / 950352  33.73%   resident C + verified asm + overlay C
named          423 / 1468    28.81%   functions carrying an adopted name
symbols        496                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              303404 / 950352  (31.93%)
handwritten asm          17104 / 950352  ( 1.80%)
GLOBAL_ASM remaining    629796 / 950352  (66.27%)
...
| game code, TU identified | 188 | 25 | 76 | 87 | `███▓▓▓▓▓▓▓▓░░░░░░░░░` 53.7% |
| game code, not yet split | 974 | 0 | 51 | 923 | `▓░░░░░░░░░░░░░░░░░░░` 5.2% |
| **total** | 1468 | 142 | 281 | 1045 | `██▓▓▓▓░░░░░░░░░░░░░░` 28.8% |
