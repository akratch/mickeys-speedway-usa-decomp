...
[![functions](https://img.shields.io/badge/functions_matched-174_of_1461_(11.91%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-329020_of_950240_(34.62%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-488_adopted-blue)](#progress)

```
functions      174 / 1461    11.91%   matched to C, byte-identical
.text bytes  35364 / 480976   7.35%   matched C in the resident segment
verified asm  17104 / 480976   3.56%   original hand-written assembly (83 functions)
overlay C   276552 / 469264  58.93%   matched C keyed by overlay and offset
whole resolved 329020 / 950240  34.62%   resident C + verified asm + overlay C
...
```
decompiled              311916 / 950240  (32.82%)
handwritten asm          17104 / 950240  ( 1.80%)
GLOBAL_ASM remaining    621172 / 950240  (65.37%)
NON_MATCHING                48 / 950240  ( 0.01%)
NON_EQUIVALENT               0 / 950240  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 299 | 167 | 104 | 28 | `███████████▓▓▓▓▓▓▓░░` 90.6% |
| game code, TU identified | 114 | 7 | 73 | 34 | `█▓▓▓▓▓▓▓▓▓▓▓▓▓░░░░░░` 70.2% |
| game code, not yet split | 1048 | 0 | 57 | 991 | `▓░░░░░░░░░░░░░░░░░░░` 5.4% |
| **total** | 1461 | 174 | 234 | 1053 | `██▓▓▓▓░░░░░░░░░░░░░░` 27.9% |
