...
[![functions](https://img.shields.io/badge/functions_matched-989_of_1464_(67.55%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-343504_of_947796_(36.24%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1272_adopted-blue)](#progress)

```
functions      989 / 1464    67.55%   matched to C, byte-identical
.text bytes 217548 / 478532  45.46%   matched C in the resident segment
...
whole resolved 343504 / 947796  36.24%   resident C + verified asm + overlay C
...
```
decompiled              326892 / 947796  (34.49%)
handwritten asm          16612 / 947796  ( 1.75%)
GLOBAL_ASM remaining    289772 / 947796  (30.57%)
