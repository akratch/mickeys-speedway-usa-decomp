...
[![functions](https://img.shields.io/badge/functions_matched-125_of_1468_(8.51%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319604_of_950360_(33.63%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-482_adopted-blue)](#progress)

```
functions      125 / 1468     8.51%   matched to C, byte-identical
.text bytes  25948 / 481096   5.39%   matched C in the resident segment
...
whole resolved 319604 / 950360  33.63%   resident C + verified asm + overlay C
named          409 / 1468    27.86%   functions carrying an adopted name
symbols        482                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              302500 / 950360  (31.83%)
handwritten asm          17104 / 950360  ( 1.80%)
GLOBAL_ASM remaining    630708 / 950360  (66.37%)
...
| game code, TU identified | 133 | 8 | 73 | 52 | `█▓▓▓▓▓▓▓▓▓▓▓░░░░░░░░` 60.9% |
| game code, not yet split | 1029 | 0 | 57 | 972 | `▓░░░░░░░░░░░░░░░░░░░` 5.5% |
| **total** | 1468 | 125 | 284 | 1059 | `██▓▓▓▓░░░░░░░░░░░░░░` 27.9% |
