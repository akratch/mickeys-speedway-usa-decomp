...
[![functions](https://img.shields.io/badge/functions_matched-158_of_1462_(10.81%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-323124_of_950292_(34.00%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-507_adopted-blue)](#progress)

```
functions      158 / 1462    10.81%   matched to C, byte-identical
.text bytes  29468 / 481028   6.13%   matched C in the resident segment
...
whole resolved 323124 / 950292  34.00%   resident C + verified asm + overlay C
named          432 / 1462    29.55%   functions carrying an adopted name
symbols        507                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              306020 / 950292  (32.20%)
handwritten asm          17104 / 950292  ( 1.80%)
GLOBAL_ASM remaining    627120 / 950292  (65.99%)
...
| game code, TU identified | 148 | 7 | 97 | 44 | `█▓▓▓▓▓▓▓▓▓▓▓▓▓░░░░░░` 70.3% |
| game code, not yet split | 1015 | 0 | 57 | 958 | `▓░░░░░░░░░░░░░░░░░░░` 5.6% |
| **total** | 1462 | 158 | 274 | 1030 | `██▓▓▓▓░░░░░░░░░░░░░░` 29.5% |
