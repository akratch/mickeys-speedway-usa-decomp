...
[![functions](https://img.shields.io/badge/functions_matched-663_of_1459_(45.44%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-206952_of_947932_(21.83%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1025_adopted-blue)](#progress)

```
functions      663 / 1459    45.44%   matched to C, byte-identical
.text bytes 118336 / 478668  24.72%   matched C in the resident segment
...
whole resolved 206952 / 947932  21.83%   resident C + verified asm + overlay C
...
```
decompiled              189848 / 947932  (20.03%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    519116 / 947932  (54.76%)
