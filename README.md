...
[![functions](https://img.shields.io/badge/functions_matched-940_of_1464_(64.21%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-302604_of_947848_(31.93%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1195_adopted-blue)](#progress)

```
functions      940 / 1464    64.21%   matched to C, byte-identical
.text bytes 187644 / 478584  39.21%   matched C in the resident segment
verified asm  17104 / 478584   3.57%   original hand-written assembly (83 functions)
overlay C    97856 / 469264  20.85%   matched C keyed by overlay and offset
whole resolved 302604 / 947848  31.93%   resident C + verified asm + overlay C
named         1096 / 1464    74.86%   functions carrying an adopted name
symbols       1195                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              285500 / 947848  (30.12%)
handwritten asm          17104 / 947848  ( 1.80%)
GLOBAL_ASM remaining    319236 / 947848  (33.68%)
NON_MATCHING            326008 / 947848  (34.39%)
