...
[![functions](https://img.shields.io/badge/functions_matched-926_of_1464_(63.25%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-295128_of_947856_(31.14%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1190_adopted-blue)](#progress)

```
functions      926 / 1464    63.25%   matched to C, byte-identical
.text bytes 182268 / 478592  38.08%   matched C in the resident segment
...
whole resolved 295128 / 947856  31.14%   resident C + verified asm + overlay C
...
```
decompiled              278024 / 947856  (29.33%)
handwritten asm          17104 / 947856  ( 1.80%)
GLOBAL_ASM remaining    324620 / 947856  (34.25%)
