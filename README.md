...
[![functions](https://img.shields.io/badge/functions_matched-32_of_1468_(2.18%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/.text_bytes_matched-3584_of_481564_(0.74%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-373_adopted-blue)](#progress)

```
functions       32 / 1468     2.18%   matched to C, byte-identical
.text bytes   3584 / 481564   0.74%   of the static resident segment
named          357 / 1468    24.32%   functions carrying an adopted name
symbols        373                    adopted in symbol_addrs.us.txt
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 307 | 26 | 243 | 38 | `██▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓░░` 87.6% |
| game code, TU identified | 74 | 6 | 45 | 23 | `██▓▓▓▓▓▓▓▓▓▓▓▓░░░░░░` 68.9% |
| game code, not yet split | 1087 | 0 | 37 | 1050 | `▓░░░░░░░░░░░░░░░░░░░` 3.4% |
| **total** | 1468 | 32 | 325 | 1111 | `█▓▓▓▓░░░░░░░░░░░░░░░` 24.3% |
...
**Matched so far**: 26 C translation units that build byte-identically. 24 under `src/libultra/`; 2 under `src/main/`, including `matrix.c` (matrix/vector maths) and `runlink.c` (the runtime overlay linker core).
