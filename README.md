...
[![functions](https://img.shields.io/badge/functions_matched-158_of_1461_(10.81%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-323172_of_950264_(34.01%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-415_adopted-blue)](#progress)

```
functions      158 / 1461    10.81%   matched to C, byte-identical
.text bytes  29468 / 481000   6.13%   matched C in the resident segment
...
whole resolved 323172 / 950264  34.01%   resident C + verified asm + overlay C
named          362 / 1461    24.78%   functions carrying an adopted name
symbols        415                    adopted in symbol_addrs.us.txt
```
