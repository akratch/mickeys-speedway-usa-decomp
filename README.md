...
[![functions](https://img.shields.io/badge/functions_matched-126_of_1468_(8.58%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319616_of_950364_(33.63%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-483_adopted-blue)](#progress)

```
functions      126 / 1468     8.58%   matched to C, byte-identical
.text bytes  25960 / 481100   5.40%   matched C in the resident segment
verified asm  17104 / 481100   3.56%   original hand-written assembly (83 functions)
overlay C   276552 / 469264  58.93%   matched C keyed by overlay and offset
whole resolved 319616 / 950364  33.63%   resident C + verified asm + overlay C
named          410 / 1468    27.93%   functions carrying an adopted name
...
```
decompiled              302512 / 950364  (31.83%)
handwritten asm          17104 / 950364  ( 1.80%)
GLOBAL_ASM remaining    630700 / 950364  (66.36%)
NON_MATCHING                48 / 950364  ( 0.01%)
NON_EQUIVALENT               0 / 950364  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 306 | 117 | 154 | 35 | `████████▓▓▓▓▓▓▓▓▓▓░░` 88.6% |
| game code, TU identified | 188 | 9 | 79 | 100 | `█▓▓▓▓▓▓▓▓░░░░░░░░░░░` 46.8% |
| game code, not yet split | 974 | 0 | 51 | 923 | `▓░░░░░░░░░░░░░░░░░░░` 5.2% |
| **total** | 1468 | 126 | 284 | 1058 | `██▓▓▓▓░░░░░░░░░░░░░░` 27.9% |
