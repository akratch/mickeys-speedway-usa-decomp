...
[![functions](https://img.shields.io/badge/functions_matched-662_of_1459_(45.37%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-209656_of_947932_(22.12%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1024_adopted-blue)](#progress)

```
functions      662 / 1459    45.37%   matched to C, byte-identical
.text bytes 117768 / 478668  24.60%   matched C in the resident segment
verified asm  17104 / 478668   3.57%   original hand-written assembly (83 functions)
overlay C    74784 / 469264  15.94%   matched C keyed by overlay and offset
whole resolved 209656 / 947932  22.12%   resident C + verified asm + overlay C
named          884 / 1459    60.59%   functions carrying an adopted name
symbols       1024                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              192552 / 947932  (20.31%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    519684 / 947932  (54.82%)
NON_MATCHING            218592 / 947932  (23.06%)
...
| game code, TU identified | 986 | 416 | 173 | 397 | `████████▓▓▓▓░░░░░░░░` 59.7% |
| game code, not yet split | 184 | 0 | 9 | 175 | `▓░░░░░░░░░░░░░░░░░░░` 4.9% |
| **total** | 1459 | 662 | 222 | 575 | `█████████▓▓▓░░░░░░░░` 60.6% |
