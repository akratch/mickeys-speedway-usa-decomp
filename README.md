...
[![functions](https://img.shields.io/badge/functions_matched-187_of_1461_(12.80%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-336556_of_950224_(35.42%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-488_adopted-blue)](#progress)

```
functions      187 / 1461    12.80%   matched to C, byte-identical
.text bytes  42900 / 480960   8.92%   matched C in the resident segment
...
whole resolved 336556 / 950224  35.42%   resident C + verified asm + overlay C
...
```
decompiled              319452 / 950224  (33.62%)
handwritten asm          17104 / 950224  ( 1.80%)
GLOBAL_ASM remaining    613620 / 950224  (64.58%)
