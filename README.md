...
[![functions](https://img.shields.io/badge/functions_matched-145_of_1468_(9.88%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-320724_of_950352_(33.75%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-499_adopted-blue)](#progress)

```
functions      145 / 1468     9.88%   matched to C, byte-identical
.text bytes  27068 / 481088   5.63%   matched C in the resident segment
...
whole resolved 320724 / 950352  33.75%   resident C + verified asm + overlay C
named          426 / 1468    29.02%   functions carrying an adopted name
symbols        499                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              303620 / 950352  (31.95%)
handwritten asm          17104 / 950352  ( 1.80%)
GLOBAL_ASM remaining    629580 / 950352  (66.25%)
...
| game code, TU identified | 188 | 28 | 76 | 84 | `███▓▓▓▓▓▓▓▓░░░░░░░░░` 55.3% |
| game code, not yet split | 974 | 0 | 51 | 923 | `▓░░░░░░░░░░░░░░░░░░░` 5.2% |
| **total** | 1468 | 145 | 281 | 1042 | `██▓▓▓▓░░░░░░░░░░░░░░` 29.0% |
