...
[![functions](https://img.shields.io/badge/functions_matched-125_of_1468_(8.51%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319628_of_950352_(33.63%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-482_adopted-blue)](#progress)

```
functions      125 / 1468     8.51%   matched to C, byte-identical
.text bytes  25972 / 481088   5.40%   matched C in the resident segment
...
whole resolved 319628 / 950352  33.63%   resident C + verified asm + overlay C
...
```
decompiled              302524 / 950352  (31.83%)
handwritten asm          17104 / 950352  ( 1.80%)
GLOBAL_ASM remaining    630676 / 950352  (66.36%)
...
| game code, TU identified | 169 | 8 | 74 | 87 | `█▓▓▓▓▓▓▓▓▓░░░░░░░░░░` 48.5% |
