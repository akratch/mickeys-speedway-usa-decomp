...
[![functions](https://img.shields.io/badge/functions_matched-181_of_1461_(12.39%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-333216_of_950228_(35.07%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-488_adopted-blue)](#progress)

```
functions      181 / 1461    12.39%   matched to C, byte-identical
.text bytes  39560 / 480964   8.23%   matched C in the resident segment
verified asm  17104 / 480964   3.56%   original hand-written assembly (83 functions)
overlay C   276552 / 469264  58.93%   matched C keyed by overlay and offset
whole resolved 333216 / 950228  35.07%   resident C + verified asm + overlay C
...
```
decompiled              316112 / 950228  (33.27%)
handwritten asm          17104 / 950228  ( 1.80%)
GLOBAL_ASM remaining    616964 / 950228  (64.93%)
NON_MATCHING                48 / 950228  ( 0.01%)
NON_EQUIVALENT               0 / 950228  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 299 | 174 | 98 | 27 | `████████████▓▓▓▓▓▓░░` 91.0% |
| game code, TU identified | 114 | 7 | 73 | 34 | `█▓▓▓▓▓▓▓▓▓▓▓▓▓░░░░░░` 70.2% |
| game code, not yet split | 1048 | 0 | 57 | 991 | `▓░░░░░░░░░░░░░░░░░░░` 5.4% |
| **total** | 1461 | 181 | 228 | 1052 | `██▓▓▓▓░░░░░░░░░░░░░░` 28.0% |
