...
[![functions](https://img.shields.io/badge/functions_matched-674_of_1459_(46.20%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-207908_of_947932_(21.93%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1035_adopted-blue)](#progress)

```
functions      674 / 1459    46.20%   matched to C, byte-identical
.text bytes 119292 / 478668  24.92%   matched C in the resident segment
...
whole resolved 207908 / 947932  21.93%   resident C + verified asm + overlay C
...
```
decompiled              190804 / 947932  (20.13%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    518160 / 947932  (54.66%)
