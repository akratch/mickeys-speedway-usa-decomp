...
[![functions](https://img.shields.io/badge/functions_matched-951_of_1464_(64.96%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-312572_of_947844_(32.98%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1199_adopted-blue)](#progress)

```
functions      951 / 1464    64.96%   matched to C, byte-identical
.text bytes 192148 / 478580  40.15%   matched C in the resident segment
...
whole resolved 312572 / 947844  32.98%   resident C + verified asm + overlay C
...
```
decompiled              295468 / 947844  (31.17%)
handwritten asm          17104 / 947844  ( 1.80%)
GLOBAL_ASM remaining    314728 / 947844  (33.20%)
