...
[![functions](https://img.shields.io/badge/functions_matched-668_of_1459_(45.78%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-206584_of_947932_(21.79%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1024_adopted-blue)](#progress)

```
functions      668 / 1459    45.78%   matched to C, byte-identical
.text bytes 117968 / 478668  24.65%   matched C in the resident segment
...
whole resolved 206584 / 947932  21.79%   resident C + verified asm + overlay C
...
```
decompiled              189480 / 947932  (19.99%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    519484 / 947932  (54.80%)
