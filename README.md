...
[![functions](https://img.shields.io/badge/functions_matched-994_of_1464_(67.90%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-345996_of_947804_(36.51%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1272_adopted-blue)](#progress)

```
functions      994 / 1464    67.90%   matched to C, byte-identical
.text bytes 220040 / 478540  45.98%   matched C in the resident segment
...
whole resolved 345996 / 947804  36.51%   resident C + verified asm + overlay C
...
```
decompiled              329384 / 947804  (34.75%)
handwritten asm          16612 / 947804  ( 1.75%)
GLOBAL_ASM remaining    287288 / 947804  (30.31%)
