...
[![functions](https://img.shields.io/badge/functions_matched-664_of_1459_(45.51%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-206404_of_947932_(21.77%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1024_adopted-blue)](#progress)

```
functions      664 / 1459    45.51%   matched to C, byte-identical
.text bytes 117788 / 478668  24.61%   matched C in the resident segment
...
whole resolved 206404 / 947932  21.77%   resident C + verified asm + overlay C
...
```
decompiled              189300 / 947932  (19.97%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    519664 / 947932  (54.82%)
