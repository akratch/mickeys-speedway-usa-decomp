...
[![functions](https://img.shields.io/badge/functions_matched-158_of_1461_(10.81%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-323124_of_950296_(34.00%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-551_adopted-blue)](#progress)

```
functions      158 / 1461    10.81%   matched to C, byte-identical
.text bytes  29468 / 481032   6.13%   matched C in the resident segment
...
whole resolved 323124 / 950296  34.00%   resident C + verified asm + overlay C
...
```
decompiled              306020 / 950296  (32.20%)
handwritten asm          17104 / 950296  ( 1.80%)
GLOBAL_ASM remaining    627124 / 950296  (65.99%)
...
| game code, TU identified | 189 | 7 | 104 | 78 | `█▓▓▓▓▓▓▓▓▓▓▓░░░░░░░░` 58.7% |
