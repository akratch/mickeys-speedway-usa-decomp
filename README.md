...
[![functions](https://img.shields.io/badge/functions_matched-663_of_1459_(45.44%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-206544_of_947932_(21.79%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1024_adopted-blue)](#progress)

```
functions      663 / 1459    45.44%   matched to C, byte-identical
.text bytes 117928 / 478668  24.64%   matched C in the resident segment
...
whole resolved 206544 / 947932  21.79%   resident C + verified asm + overlay C
...
```
decompiled              189440 / 947932  (19.98%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    519524 / 947932  (54.81%)
