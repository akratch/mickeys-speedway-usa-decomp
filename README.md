...
[![functions](https://img.shields.io/badge/functions_matched-668_of_1459_(45.78%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-207188_of_947932_(21.86%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1029_adopted-blue)](#progress)

```
functions      668 / 1459    45.78%   matched to C, byte-identical
.text bytes 118572 / 478668  24.77%   matched C in the resident segment
...
whole resolved 207188 / 947932  21.86%   resident C + verified asm + overlay C
...
```
decompiled              190084 / 947932  (20.05%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    518880 / 947932  (54.74%)
