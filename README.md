...
[![functions](https://img.shields.io/badge/functions_matched-128_of_1468_(8.72%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-319796_of_950348_(33.65%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-485_adopted-blue)](#progress)

```
functions      128 / 1468     8.72%   matched to C, byte-identical
.text bytes  26140 / 481084   5.43%   matched C in the resident segment
...
whole resolved 319796 / 950348  33.65%   resident C + verified asm + overlay C
...
```
decompiled              302692 / 950348  (31.85%)
handwritten asm          17104 / 950348  ( 1.80%)
GLOBAL_ASM remaining    630504 / 950348  (66.34%)
...
| game code, TU identified | 148 | 11 | 74 | 63 | `█▓▓▓▓▓▓▓▓▓▓░░░░░░░░░` 57.4% |
