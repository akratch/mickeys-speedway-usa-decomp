...
[![functions](https://img.shields.io/badge/functions_matched-156_of_1468_(10.63%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-321616_of_950352_(33.84%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-510_adopted-blue)](#progress)

```
functions      156 / 1468    10.63%   matched to C, byte-identical
.text bytes  27960 / 481088   5.81%   matched C in the resident segment
...
whole resolved 321616 / 950352  33.84%   resident C + verified asm + overlay C
named          437 / 1468    29.77%   functions carrying an adopted name
symbols        510                    adopted in symbol_addrs.us.txt
```
...
```
decompiled              304512 / 950352  (32.04%)
handwritten asm          17104 / 950352  ( 1.80%)
GLOBAL_ASM remaining    628688 / 950352  (66.15%)
...
| game code, TU identified | 188 | 39 | 76 | 73 | `████▓▓▓▓▓▓▓▓░░░░░░░░` 61.2% |
| game code, not yet split | 974 | 0 | 51 | 923 | `▓░░░░░░░░░░░░░░░░░░░` 5.2% |
| **total** | 1468 | 156 | 281 | 1031 | `██▓▓▓▓░░░░░░░░░░░░░░` 29.8% |
