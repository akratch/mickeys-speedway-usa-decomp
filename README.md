...
[![functions](https://img.shields.io/badge/functions_matched-663_of_1459_(45.44%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-207436_of_947932_(21.88%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1025_adopted-blue)](#progress)

```
functions      663 / 1459    45.44%   matched to C, byte-identical
.text bytes 118820 / 478668  24.82%   matched C in the resident segment
...
whole resolved 207436 / 947932  21.88%   resident C + verified asm + overlay C
...
```
decompiled              190332 / 947932  (20.08%)
handwritten asm          17104 / 947932  ( 1.80%)
GLOBAL_ASM remaining    518632 / 947932  (54.71%)
