...
[![functions](https://img.shields.io/badge/functions_matched-925_of_1464_(63.18%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-294536_of_947852_(31.07%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1190_adopted-blue)](#progress)

```
functions      925 / 1464    63.18%   matched to C, byte-identical
.text bytes 181732 / 478588  37.97%   matched C in the resident segment
...
whole resolved 294536 / 947852  31.07%   resident C + verified asm + overlay C
...
```
decompiled              277432 / 947852  (29.27%)
handwritten asm          17104 / 947852  ( 1.80%)
GLOBAL_ASM remaining    325152 / 947852  (34.30%)
NON_MATCHING            328164 / 947852  (34.62%)
