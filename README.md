...
[![functions](https://img.shields.io/badge/functions_matched-165_of_1461_(11.29%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-324736_of_950260_(34.17%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-483_adopted-blue)](#progress)

```
functions      165 / 1461    11.29%   matched to C, byte-identical
.text bytes  31080 / 480996   6.46%   matched C in the resident segment
verified asm  17104 / 480996   3.56%   original hand-written assembly (83 functions)
overlay C   276552 / 469264  58.93%   matched C keyed by overlay and offset
whole resolved 324736 / 950260  34.17%   resident C + verified asm + overlay C
...
```
decompiled              307632 / 950260  (32.37%)
handwritten asm          17104 / 950260  ( 1.80%)
GLOBAL_ASM remaining    625476 / 950260  (65.82%)
NON_MATCHING                48 / 950260  ( 0.01%)
NON_EQUIVALENT               0 / 950260  ( 0.00%)
```

| Area | Functions | Matched to C | Named, still asm | Unnamed | Identified |
| :--- | ---: | ---: | ---: | ---: | :--- |
| libultra corridor | 299 | 158 | 113 | 28 | `███████████▓▓▓▓▓▓▓░░` 90.6% |
| game code, TU identified | 114 | 7 | 73 | 34 | `█▓▓▓▓▓▓▓▓▓▓▓▓▓░░░░░░` 70.2% |
| game code, not yet split | 1048 | 0 | 57 | 991 | `▓░░░░░░░░░░░░░░░░░░░` 5.4% |
| **total** | 1461 | 165 | 243 | 1053 | `██▓▓▓▓░░░░░░░░░░░░░░` 27.9% |
